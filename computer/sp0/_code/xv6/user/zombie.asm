...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 38e:	50e50513          	add	a0,a0,1294 # 898 <digits>
 392:	883e                	mv	a6,a5
 394:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 624:	278b8b93          	add	s7,s7,632 # 898 <digits>
 628:	03c9d793          	srl	a5,s3,0x3c
 ...
 686:	20e90913          	add	s2,s2,526 # 890 <malloc+0x102>
        for(; *s; s++)
