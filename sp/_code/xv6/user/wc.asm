...
wc(int fd, char *name)
{
  ...
  3c:	998a0a13          	add	s4,s4,-1640 # 9d0 <malloc+0x104>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	95250513          	add	a0,a0,-1710 # 9f0 <malloc+0x124>
  ...
  cc:	91850513          	add	a0,a0,-1768 # 9e0 <malloc+0x114>
...
main(int argc, char *argv[])
{
 ...
 136:	8a658593          	add	a1,a1,-1882 # 9d8 <malloc+0x10c>
 13a:	4501                	li	a0,0
 ...
 14e:	8b650513          	add	a0,a0,-1866 # a00 <malloc+0x134>
...
{
 294:	1101                	add	sp,sp,-32
 296:	ec06                	sd	ra,24(sp)
 298:	e822                	sd	s0,16(sp)
 29a:	e04a                	sd	s2,0(sp)
 29c:	1000                	add	s0,sp,32
 29e:	892e                	mv	s2,a1
  int fd;
  int r;
...
atoi(const char *s)
{
 ...
 2e8:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
 2ea:	0705                	add	a4,a4,1
 2ec:	0025179b          	sllw	a5,a0,0x2
 2f0:	9fa9                	addw	a5,a5,a0
 2f2:	0017979b          	sllw	a5,a5,0x1
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 35a:	97ba                	add	a5,a5,a4
      *--dst = *--src;
 35c:	15fd                	add	a1,a1,-1
 35e:	177d                	add	a4,a4,-1
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 376:	fff6069b          	addw	a3,a2,-1
 37a:	1682                	sll	a3,a3,0x20
 37c:	9281                	srl	a3,a3,0x20
 37e:	0685                	add	a3,a3,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4cc:	55850513          	add	a0,a0,1368 # a20 <digits>
 4d0:	883e                	mv	a6,a5
 4d2:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 762:	2c2b8b93          	add	s7,s7,706 # a20 <digits>
 766:	03c9d793          	srl	a5,s3,0x3c
 ...
 7c4:	25890913          	add	s2,s2,600 # a18 <malloc+0x14c>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 930:	8e478793          	add	a5,a5,-1820 # 1210 <base>
 ...
 992:	c798                	sw	a4,8(a5)
        p += p->s.size;
 994:	02071693          	sll	a3,a4,0x20
 998:	01c6d713          	srl	a4,a3,0x1c
