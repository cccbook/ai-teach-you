...
main(int argc, char **argv)
{
  ...
  14:	92050513          	add	a0,a0,-1760 # 930 <malloc+0xfc>
  ...
  30:	90450513          	add	a0,a0,-1788 # 930 <malloc+0xfc>
  ...
  42:	8f250513          	add	a0,a0,-1806 # 930 <malloc+0xfc>
  ...
  56:	93e50513          	add	a0,a0,-1730 # 990 <malloc+0x15c>
  ...
  6a:	8da50513          	add	a0,a0,-1830 # 940 <malloc+0x10c>
  ...
  7c:	8e068693          	add	a3,a3,-1824 # 958 <malloc+0x124>
  80:	8626                	mv	a2,s1
  82:	00001597          	auipc	a1,0x1
  86:	8de58593          	add	a1,a1,-1826 # 960 <malloc+0x12c>
  8a:	4509                	li	a0,2
  ...
  9c:	8e050513          	add	a0,a0,-1824 # 978 <malloc+0x144>
  ...
  b2:	8fa50513          	add	a0,a0,-1798 # 9a8 <malloc+0x174>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 434:	5a050513          	add	a0,a0,1440 # 9d0 <digits>
 438:	883e                	mv	a6,a5
 43a:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ca:	30ab8b93          	add	s7,s7,778 # 9d0 <digits>
 6ce:	03c9d793          	srl	a5,s3,0x3c
 6d2:	97de                	add	a5,a5,s7
 6d4:	0007c583          	lbu	a1,0(a5)
 6d8:	855a                	mv	a0,s6
 6da:	d1fff0ef          	jal	3f8 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6de:	0992                	sll	s3,s3,0x4
 6e0:	397d                	addw	s2,s2,-1
 ...
 72c:	2a090913          	add	s2,s2,672 # 9c8 <malloc+0x194>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 898:	97478793          	add	a5,a5,-1676 # 1208 <base>
 ...
 8fa:	c798                	sw	a4,8(a5)
        p += p->s.size;
 8fc:	02071693          	sll	a3,a4,0x20
 900:	01c6d713          	srl	a4,a3,0x1c
