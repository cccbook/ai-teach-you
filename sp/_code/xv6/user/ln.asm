...
main(int argc, char *argv[])
{
  ...
  14:	8b058593          	add	a1,a1,-1872 # 8c0 <malloc+0x102>
  18:	4509                	li	a0,2
  ...
  42:	89a58593          	add	a1,a1,-1894 # 8d8 <malloc+0x11a>
  46:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3be:	53e50513          	add	a0,a0,1342 # 8f8 <digits>
 3c2:	883e                	mv	a6,a5
 3c4:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 654:	2a8b8b93          	add	s7,s7,680 # 8f8 <digits>
 658:	03c9d793          	srl	a5,s3,0x3c
 65c:	97de                	add	a5,a5,s7
 65e:	0007c583          	lbu	a1,0(a5)
 662:	855a                	mv	a0,s6
 664:	d1fff0ef          	jal	382 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 668:	0992                	sll	s3,s3,0x4
 66a:	397d                	addw	s2,s2,-1
 ...
 6b6:	23e90913          	add	s2,s2,574 # 8f0 <malloc+0x132>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 80e:	7f690913          	add	s2,s2,2038 # 1000 <freep>
  if(p == SBRK_ERROR)
 812:	5afd                	li	s5,-1
