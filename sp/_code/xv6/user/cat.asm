...
cat(int fd)
{
  ...
  3c:	92858593          	add	a1,a1,-1752 # 960 <malloc+0x106>
  40:	4509                	li	a0,2
  ...
  62:	91a58593          	add	a1,a1,-1766 # 978 <malloc+0x11e>
  66:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  da:	8ba58593          	add	a1,a1,-1862 # 990 <malloc+0x136>
  de:	4509                	li	a0,2
...
{
 222:	1101                	add	sp,sp,-32
 224:	ec06                	sd	ra,24(sp)
 226:	e822                	sd	s0,16(sp)
 228:	e04a                	sd	s2,0(sp)
 22a:	1000                	add	s0,sp,32
 22c:	892e                	mv	s2,a1
  int fd;
  int r;
...
atoi(const char *s)
{
 ...
 27a:	0025179b          	sllw	a5,a0,0x2
 27e:	9fa9                	addw	a5,a5,a0
 280:	0017979b          	sllw	a5,a5,0x1
 284:	9fb5                	addw	a5,a5,a3
 286:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2dc:	fff6079b          	addw	a5,a2,-1
 2e0:	1782                	sll	a5,a5,0x20
 2e2:	9381                	srl	a5,a5,0x20
 2e4:	fff7c793          	not	a5,a5
 2e8:	97ba                	add	a5,a5,a4
      *--dst = *--src;
 2ea:	15fd                	add	a1,a1,-1
 2ec:	177d                	add	a4,a4,-1
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 304:	fff6069b          	addw	a3,a2,-1
 308:	1682                	sll	a3,a3,0x20
 30a:	9281                	srl	a3,a3,0x20
 30c:	0685                	add	a3,a3,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 45a:	55a50513          	add	a0,a0,1370 # 9b0 <digits>
 45e:	883e                	mv	a6,a5
 460:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f0:	2c4b8b93          	add	s7,s7,708 # 9b0 <digits>
 ...
 752:	25a90913          	add	s2,s2,602 # 9a8 <malloc+0x14e>
        for(; *s; s++)
...
free(void *ap)
{
 7d8:	1141                	add	sp,sp,-16
 7da:	e422                	sd	s0,8(sp)
 7dc:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 7de:	ff050693          	add	a3,a0,-16
 ...
 80e:	00e6ea63          	bltu	a3,a4,822 <free+0x4a>
{
 ...
 826:	6390                	ld	a2,0(a5)
 828:	02059813          	sll	a6,a1,0x20
 82c:	01c85713          	srl	a4,a6,0x1c
 ...
 836:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 83a:	4790                	lw	a2,8(a5)
 83c:	02061593          	sll	a1,a2,0x20
 840:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 866:	02051493          	sll	s1,a0,0x20
 86a:	9081                	srl	s1,s1,0x20
 86c:	04bd                	add	s1,s1,15
 86e:	8091                	srl	s1,s1,0x4
 870:	0014899b          	addw	s3,s1,1
 874:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 8aa:	75a90913          	add	s2,s2,1882 # 1000 <freep>
  if(p == SBRK_ERROR)
 8ae:	5afd                	li	s5,-1
 ...
 8be:	95678793          	add	a5,a5,-1706 # 1210 <base>
 ...
 920:	c798                	sw	a4,8(a5)
        p += p->s.size;
 922:	02071693          	sll	a3,a4,0x20
 926:	01c6d713          	srl	a4,a3,0x1c
