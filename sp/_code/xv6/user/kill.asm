...
main(int argc, char **argv)
{
  ...
  44:	88058593          	add	a1,a1,-1920 # 8c0 <malloc+0xfc>
  48:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3c4:	52050513          	add	a0,a0,1312 # 8e0 <digits>
 3c8:	883e                	mv	a6,a5
 ...
 404:	fb840713          	add	a4,s0,-72
 408:	00f704b3          	add	s1,a4,a5
 40c:	fff70993          	add	s3,a4,-1
 410:	99be                	add	s3,s3,a5
 412:	37fd                	addw	a5,a5,-1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 65a:	28ab8b93          	add	s7,s7,650 # 8e0 <digits>
 ...
 6bc:	22090913          	add	s2,s2,544 # 8d8 <malloc+0x114>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 88a:	c798                	sw	a4,8(a5)
        p += p->s.size;
 88c:	02071693          	sll	a3,a4,0x20
 890:	01c6d713          	srl	a4,a3,0x1c
