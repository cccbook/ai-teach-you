...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	8c278793          	add	a5,a5,-1854 # 78d0 <malloc+0x2680>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	2ea50513          	add	a0,a0,746 # 5350 <malloc+0x100>
      ...
      94:	8082                	ret
{
      ...
      a4:	2d050513          	add	a0,a0,720 # 5370 <malloc+0x120>
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	2c850513          	add	a0,a0,712 # 5388 <malloc+0x138>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	2d250513          	add	a0,a0,722 # 53a8 <malloc+0x158>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	29e50513          	add	a0,a0,670 # 5390 <malloc+0x140>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	2b250513          	add	a0,a0,690 # 53b8 <malloc+0x168>
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	26450513          	add	a0,a0,612 # 53e0 <malloc+0x190>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	25a50513          	add	a0,a0,602 # 5400 <malloc+0x1b0>
...
000000000000022c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	17650513          	add	a0,a0,374 # 5438 <malloc+0x1e8>
     ...
     2e0:	17c50513          	add	a0,a0,380 # 5458 <malloc+0x208>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	17250513          	add	a0,a0,370 # 5470 <malloc+0x220>
     306:	2bf040ef          	jal	4dc4 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	16298993          	add	s3,s3,354 # 5470 <malloc+0x220>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	12650513          	add	a0,a0,294 # 5470 <malloc+0x220>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    exit(1);
     ...
     386:	0f650513          	add	a0,a0,246 # 5478 <malloc+0x228>
    ...
    printf("open junk failed\n");
     ...
     398:	0e450513          	add	a0,a0,228 # 5478 <malloc+0x228>
  ...
  unlink("junk");
     ...
     3b0:	0c450513          	add	a0,a0,196 # 5470 <malloc+0x220>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	44078793          	add	a5,a5,1088 # 78d0 <malloc+0x2680>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	fe2a0a13          	add	s4,s4,-30 # 54a0 <malloc+0x250>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	f6450513          	add	a0,a0,-156 # 54a8 <malloc+0x258>
     ...
     55e:	f6650513          	add	a0,a0,-154 # 54c0 <malloc+0x270>
     ...
     574:	f8050513          	add	a0,a0,-128 # 54f0 <malloc+0x2a0>
     ...
     586:	f9e50513          	add	a0,a0,-98 # 5520 <malloc+0x2d0>
     ...
     59c:	f9850513          	add	a0,a0,-104 # 5530 <malloc+0x2e0>
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	31278793          	add	a5,a5,786 # 78d0 <malloc+0x2680>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	f6ea0a13          	add	s4,s4,-146 # 5560 <malloc+0x310>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	dfea8a93          	add	s5,s5,-514 # 53f8 <malloc+0x1a8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	eea50513          	add	a0,a0,-278 # 5568 <malloc+0x318>
     ...
     698:	eec50513          	add	a0,a0,-276 # 5580 <malloc+0x330>
     ...
     6aa:	e7a50513          	add	a0,a0,-390 # 5520 <malloc+0x2d0>
     ...
     6bc:	ef850513          	add	a0,a0,-264 # 55b0 <malloc+0x360>
     ...
     6d2:	efa50513          	add	a0,a0,-262 # 55c8 <malloc+0x378>
...
00000000000006e0 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	cb850513          	add	a0,a0,-840 # 53e0 <malloc+0x190>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	c9450513          	add	a0,a0,-876 # 53e0 <malloc+0x190>
     754:	660040ef          	jal	4db4 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	c8450513          	add	a0,a0,-892 # 53e0 <malloc+0x190>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	eca58593          	add	a1,a1,-310 # 5658 <malloc+0x408>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	c1c50513          	add	a0,a0,-996 # 53e0 <malloc+0x190>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	e0050513          	add	a0,a0,-512 # 55f8 <malloc+0x3a8>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	e0c50513          	add	a0,a0,-500 # 5618 <malloc+0x3c8>
     814:	189040ef          	jal	519c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	e0c50513          	add	a0,a0,-500 # 5628 <malloc+0x3d8>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	e1850513          	add	a0,a0,-488 # 5648 <malloc+0x3f8>
     838:	165040ef          	jal	519c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	de850513          	add	a0,a0,-536 # 5628 <malloc+0x3d8>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	e0a50513          	add	a0,a0,-502 # 5660 <malloc+0x410>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	e1450513          	add	a0,a0,-492 # 5680 <malloc+0x430>
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	e0850513          	add	a0,a0,-504 # 56a0 <malloc+0x450>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	e1c98993          	add	s3,s3,-484 # 56c8 <malloc+0x478>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	e4ca8a93          	add	s5,s5,-436 # 5700 <malloc+0x4b0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	db250513          	add	a0,a0,-590 # 56a0 <malloc+0x450>
  ...
  if(unlink("small") < 0){
     ...
     922:	d8250513          	add	a0,a0,-638 # 56a0 <malloc+0x450>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	d6450513          	add	a0,a0,-668 # 56a8 <malloc+0x458>
    ...
    exit(1);
     ...
     95e:	d7e50513          	add	a0,a0,-642 # 56d8 <malloc+0x488>
     ...
     974:	da050513          	add	a0,a0,-608 # 5710 <malloc+0x4c0>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	db450513          	add	a0,a0,-588 # 5738 <malloc+0x4e8>
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	dc050513          	add	a0,a0,-576 # 5758 <malloc+0x508>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	dc450513          	add	a0,a0,-572 # 5770 <malloc+0x520>
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	dba50513          	add	a0,a0,-582 # 5790 <malloc+0x540>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	d7450513          	add	a0,a0,-652 # 5790 <malloc+0x540>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	d3c50513          	add	a0,a0,-708 # 5798 <malloc+0x548>
    ...
    exit(1);
     ...
     a76:	d4650513          	add	a0,a0,-698 # 57b8 <malloc+0x568>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	d5a50513          	add	a0,a0,-678 # 57e0 <malloc+0x590>
  ...
  if(unlink("big") < 0){
     ...
     aaa:	cea50513          	add	a0,a0,-790 # 5790 <malloc+0x540>
     ...
     ad0:	d3450513          	add	a0,a0,-716 # 5800 <malloc+0x5b0>
     ...
     ae6:	d4650513          	add	a0,a0,-698 # 5828 <malloc+0x5d8>
     ...
     afc:	d4850513          	add	a0,a0,-696 # 5840 <malloc+0x5f0>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	d5c50513          	add	a0,a0,-676 # 5868 <malloc+0x618>
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	d4e50513          	add	a0,a0,-690 # 5880 <malloc+0x630>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	d6a58593          	add	a1,a1,-662 # 58b0 <malloc+0x660>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	d2650513          	add	a0,a0,-730 # 5880 <malloc+0x630>
  ...
  unlink("unlinkread");
     ...
     be6:	c9e50513          	add	a0,a0,-866 # 5880 <malloc+0x630>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	c9250513          	add	a0,a0,-878 # 5890 <malloc+0x640>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	ca650513          	add	a0,a0,-858 # 58b8 <malloc+0x668>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	cb250513          	add	a0,a0,-846 # 58d8 <malloc+0x688>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	cc650513          	add	a0,a0,-826 # 5900 <malloc+0x6b0>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	cd250513          	add	a0,a0,-814 # 5920 <malloc+0x6d0>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	cde50513          	add	a0,a0,-802 # 5940 <malloc+0x6f0>
...
0000000000000c74 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	bfe58593          	add	a1,a1,-1026 # 58b0 <malloc+0x660>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	be650513          	add	a0,a0,-1050 # 5970 <malloc+0x720>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	bea50513          	add	a0,a0,-1046 # 5988 <malloc+0x738>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	bee50513          	add	a0,a0,-1042 # 59a0 <malloc+0x750>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	bfa50513          	add	a0,a0,-1030 # 59c0 <malloc+0x770>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	c1650513          	add	a0,a0,-1002 # 59f0 <malloc+0x7a0>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	c1a50513          	add	a0,a0,-998 # 5a08 <malloc+0x7b8>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	c1e50513          	add	a0,a0,-994 # 5a20 <malloc+0x7d0>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	c3250513          	add	a0,a0,-974 # 5a48 <malloc+0x7f8>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	c4e50513          	add	a0,a0,-946 # 5a78 <malloc+0x828>
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	c4498993          	add	s3,s3,-956 # 5a98 <malloc+0x848>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	c1c50513          	add	a0,a0,-996 # 5aa8 <malloc+0x858>
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	c1450513          	add	a0,a0,-1004 # 5ac8 <malloc+0x878>
     ebc:	709030ef          	jal	4dc4 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	c0450513          	add	a0,a0,-1020 # 5ac8 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	beaa0a13          	add	s4,s4,-1046 # 5ac8 <malloc+0x878>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	b9c50513          	add	a0,a0,-1124 # 5ac8 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	b3c50513          	add	a0,a0,-1220 # 5ad0 <malloc+0x880>
    ...
    exit(1);
     ...
     fb2:	b4250513          	add	a0,a0,-1214 # 5af0 <malloc+0x8a0>
     ...
     fc6:	b5650513          	add	a0,a0,-1194 # 5b18 <malloc+0x8c8>
...
0000000000001000 <badarg>:
{
    ...
    101e:	36e98993          	add	s3,s3,878 # 5388 <malloc+0x138>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	bd878793          	add	a5,a5,-1064 # 6c68 <malloc+0x1a18>
  ...
  if(pid == 0){
    ...
    10e8:	7ec78793          	add	a5,a5,2028 # 78d0 <malloc+0x2680>
    ...
    110c:	28050513          	add	a0,a0,640 # 5388 <malloc+0x138>
    ...
    1120:	aa450513          	add	a0,a0,-1372 # 5bc0 <malloc+0x970>
    ...
    1138:	a0450513          	add	a0,a0,-1532 # 5b38 <malloc+0x8e8>
    ...
    1150:	a0c50513          	add	a0,a0,-1524 # 5b58 <malloc+0x908>
    ...
    116a:	a1250513          	add	a0,a0,-1518 # 5b78 <malloc+0x928>
    ...
    1182:	a2250513          	add	a0,a0,-1502 # 5ba0 <malloc+0x950>
    ...
    1194:	03050513          	add	a0,a0,48 # 71c0 <malloc+0x1f70>
  ...
  if(st != 747){
    ...
    11ce:	a1e50513          	add	a0,a0,-1506 # 5be8 <malloc+0x998>
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	1f450513          	add	a0,a0,500 # 53e0 <malloc+0x190>
  ...
  if(pid == 0){
    ...
    1216:	1cea0a13          	add	s4,s4,462 # 53e0 <malloc+0x190>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	a2ea8a93          	add	s5,s5,-1490 # 5c48 <malloc+0x9f8>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	9a250513          	add	a0,a0,-1630 # 5c18 <malloc+0x9c8>
    ...
    128e:	9a650513          	add	a0,a0,-1626 # 5c30 <malloc+0x9e0>
    ...
    12a4:	9b850513          	add	a0,a0,-1608 # 5c58 <malloc+0xa08>
    ...
    12c2:	122a0a13          	add	s4,s4,290 # 53e0 <malloc+0x190>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	9b2a8a93          	add	s5,s5,-1614 # 5c78 <malloc+0xa28>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	0e050513          	add	a0,a0,224 # 53e0 <malloc+0x190>
  ...
  exit(xstatus);
    ...
    131a:	91a50513          	add	a0,a0,-1766 # 5c30 <malloc+0x9e0>
    ...
    1330:	95450513          	add	a0,a0,-1708 # 5c80 <malloc+0xa30>
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	03e78793          	add	a5,a5,62 # 5388 <malloc+0x138>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	94a78793          	add	a5,a5,-1718 # 5ca0 <malloc+0xa50>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	94250513          	add	a0,a0,-1726 # 5ca8 <malloc+0xa58>
  ...
  if(pid == 0) {
    ...
    138e:	91e50513          	add	a0,a0,-1762 # 5ca8 <malloc+0xa58>
    ...
    13a6:	92650513          	add	a0,a0,-1754 # 5cc8 <malloc+0xa78>
    ...
    13bc:	86050513          	add	a0,a0,-1952 # 5c18 <malloc+0x9c8>
    ...
    13d0:	8e450513          	add	a0,a0,-1820 # 5cb0 <malloc+0xa60>
    ...
    13e6:	fa650513          	add	a0,a0,-90 # 5388 <malloc+0x138>
  ...
  if(xstatus != 0)
    ...
    140e:	8ce50513          	add	a0,a0,-1842 # 5cd8 <malloc+0xa88>
    ...
    1422:	8d250513          	add	a0,a0,-1838 # 5cf0 <malloc+0xaa0>
    1426:	577030ef          	jal	519c <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	87a50513          	add	a0,a0,-1926 # 5ca8 <malloc+0xa58>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	30850513          	add	a0,a0,776 # 5758 <malloc+0x508>
    ...
    1468:	7cc50513          	add	a0,a0,1996 # 5c30 <malloc+0x9e0>
  ...
  unlink("echo-ok");
    ...
    147a:	83250513          	add	a0,a0,-1998 # 5ca8 <malloc+0xa58>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	86c50513          	add	a0,a0,-1940 # 5d08 <malloc+0xab8>
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	7d850513          	add	a0,a0,2008 # 5d20 <malloc+0xad0>
    ...
    1582:	42da8a93          	add	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	77650513          	add	a0,a0,1910 # 5d38 <malloc+0xae8>
    ...
    15da:	77a50513          	add	a0,a0,1914 # 5d50 <malloc+0xb00>
    ...
    160a:	76250513          	add	a0,a0,1890 # 5d68 <malloc+0xb18>
    ...
    1642:	74a50513          	add	a0,a0,1866 # 5d88 <malloc+0xb38>
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	57850513          	add	a0,a0,1400 # 5c18 <malloc+0x9c8>
    ...
    16b8:	6ec50513          	add	a0,a0,1772 # 5da0 <malloc+0xb50>
    ...
    16cc:	6f050513          	add	a0,a0,1776 # 5db8 <malloc+0xb68>
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	4f450513          	add	a0,a0,1268 # 5c18 <malloc+0x9c8>
    ...
    1740:	4dc50513          	add	a0,a0,1244 # 5c18 <malloc+0x9c8>
...
0000000000001752 <forkfork>:
{
    ...
    179e:	63e50513          	add	a0,a0,1598 # 5dd8 <malloc+0xb88>
    ...
    17a8:	5cc030ef          	jal	4d74 <exit>
{
    ...
    17da:	61250513          	add	a0,a0,1554 # 5de8 <malloc+0xb98>
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	9b050513          	add	a0,a0,-1616 # 71c0 <malloc+0x1f70>
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	38650513          	add	a0,a0,902 # 5c18 <malloc+0x9c8>
    ...
    18ba:	3fa50513          	add	a0,a0,1018 # 5cb0 <malloc+0xa60>
    ...
    1918:	4f450513          	add	a0,a0,1268 # 5e08 <malloc+0xbb8>
    ...
    193c:	4e850513          	add	a0,a0,1256 # 5e20 <malloc+0xbd0>
    ...
    198e:	4be50513          	add	a0,a0,1214 # 5e48 <malloc+0xbf8>
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	9d450513          	add	a0,a0,-1580 # 53f8 <malloc+0x1a8>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	9a0b0b13          	add	s6,s6,-1632 # 53f8 <malloc+0x1a8>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	410c0c13          	add	s8,s8,1040 # 5e70 <malloc+0xc20>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	1ac50513          	add	a0,a0,428 # 5c18 <malloc+0x9c8>
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	3b450513          	add	a0,a0,948 # 5ec0 <malloc+0xc70>
    ...
    1b28:	35450513          	add	a0,a0,852 # 5e78 <malloc+0xc28>
    ...
    1b3c:	35850513          	add	a0,a0,856 # 5e90 <malloc+0xc40>
    ...
    1b50:	35c50513          	add	a0,a0,860 # 5ea8 <malloc+0xc58>
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	02e50513          	add	a0,a0,46 # 5c18 <malloc+0x9c8>
    ...
    1c08:	2e450513          	add	a0,a0,740 # 5ee8 <malloc+0xc98>
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	fa650513          	add	a0,a0,-90 # 5c18 <malloc+0x9c8>
    ...
    1c9a:	27250513          	add	a0,a0,626 # 5f08 <malloc+0xcb8>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	23a50513          	add	a0,a0,570 # 5f20 <malloc+0xcd0>
    ...
    1cfe:	f1e50513          	add	a0,a0,-226 # 5c18 <malloc+0x9c8>
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	bae78793          	add	a5,a5,-1106 # 78d0 <malloc+0x2680>
  ...
  exit(0);
    ...
    1d8e:	1be50513          	add	a0,a0,446 # 5f48 <malloc+0xcf8>
    ...
    1da2:	e7a50513          	add	a0,a0,-390 # 5c18 <malloc+0x9c8>
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	3b650513          	add	a0,a0,950 # 71c0 <malloc+0x1f70>
    ...
    1ea0:	0cc50513          	add	a0,a0,204 # 5f68 <malloc+0xd18>
    ...
    1eb8:	5a450513          	add	a0,a0,1444 # 5458 <malloc+0x208>
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	d4078793          	add	a5,a5,-704 # 6c68 <malloc+0x1a18>
  ...
  if(ret != -1){
    ...
    1f66:	01e50513          	add	a0,a0,30 # 5f80 <malloc+0xd30>
    ...
    1f7c:	bc050513          	add	a0,a0,-1088 # 5b38 <malloc+0x8e8>
    ...
    1f92:	bca50513          	add	a0,a0,-1078 # 5b58 <malloc+0x908>
    ...
    1faa:	bd250513          	add	a0,a0,-1070 # 5b78 <malloc+0x928>
    ...
    1fc0:	be450513          	add	a0,a0,-1052 # 5ba0 <malloc+0x950>
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	fc850513          	add	a0,a0,-56 # 5fc0 <malloc+0xd70>
  ...
  if(n >= 0){
    ...
    2024:	fc050513          	add	a0,a0,-64 # 5fe0 <malloc+0xd90>
    ...
    203a:	f5250513          	add	a0,a0,-174 # 5f88 <malloc+0xd38>
    ...
    204e:	f5650513          	add	a0,a0,-170 # 5fa0 <malloc+0xd50>
    ...
    2060:	f6c50513          	add	a0,a0,-148 # 5fc8 <malloc+0xd78>
  ...
  unlink("rwsbrk");
    ...
    2078:	f4c50513          	add	a0,a0,-180 # 5fc0 <malloc+0xd70>
    207c:	549020ef          	jal	4dc4 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	4de50513          	add	a0,a0,1246 # 5560 <malloc+0x310>
  ...
  if(n >= 0){
    ...
    20a8:	f6c50513          	add	a0,a0,-148 # 6010 <malloc+0xdc0>
    ...
    20ba:	4b250513          	add	a0,a0,1202 # 5568 <malloc+0x318>
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	f1850513          	add	a0,a0,-232 # 6038 <malloc+0xde8>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	ee850513          	add	a0,a0,-280 # 6058 <malloc+0xe08>
  ...
  if(c != a + 1){
    ...
    21c0:	efc50513          	add	a0,a0,-260 # 60b8 <malloc+0xe68>
    ...
    21da:	ea250513          	add	a0,a0,-350 # 6078 <malloc+0xe28>
    ...
    21ee:	eae50513          	add	a0,a0,-338 # 6098 <malloc+0xe48>
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	e0650513          	add	a0,a0,-506 # 60d8 <malloc+0xe88>
    ...
    22ea:	e3a50513          	add	a0,a0,-454 # 6120 <malloc+0xed0>
    ...
    2302:	e4250513          	add	a0,a0,-446 # 6140 <malloc+0xef0>
    ...
    231a:	e6a50513          	add	a0,a0,-406 # 6180 <malloc+0xf30>
    ...
    232e:	e8650513          	add	a0,a0,-378 # 61b0 <malloc+0xf60>
    ...
    2346:	ea650513          	add	a0,a0,-346 # 61e8 <malloc+0xf98>
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	ea050513          	add	a0,a0,-352 # 6210 <malloc+0xfc0>
    2378:	23d020ef          	jal	4db4 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	e9250513          	add	a0,a0,-366 # 6210 <malloc+0xfc0>
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	e5a50513          	add	a0,a0,-422 # 6218 <malloc+0xfc8>
    ...
    23d6:	e5e50513          	add	a0,a0,-418 # 6230 <malloc+0xfe0>
    ...
    23ea:	93a50513          	add	a0,a0,-1734 # 5d20 <malloc+0xad0>
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	e4050513          	add	a0,a0,-448 # 6248 <malloc+0xff8>
  ...
  close(fd);
    ...
    2444:	7f050513          	add	a0,a0,2032 # 5c30 <malloc+0x9e0>
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	d4a50513          	add	a0,a0,-694 # 71c0 <malloc+0x1f70>
  ...
  if(pid == 0){
    ...
    24b4:	d1050513          	add	a0,a0,-752 # 71c0 <malloc+0x1f70>
  ...
  if(pid == 0){
    ...
    24f4:	cd050513          	add	a0,a0,-816 # 71c0 <malloc+0x1f70>
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	bb050513          	add	a0,a0,-1104 # 71c0 <malloc+0x1f70>
    ...
    2654:	d3850513          	add	a0,a0,-712 # 5388 <malloc+0x138>
    2658:	faa43c23          	sd	a0,-72(s0)
    265c:	00003797          	auipc	a5,0x3
    2660:	d9c78793          	add	a5,a5,-612 # 53f8 <malloc+0x1a8>
...
000000000000267a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26aa:	c2a50513          	add	a0,a0,-982 # 62d0 <malloc+0x1080>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	c8c50513          	add	a0,a0,-884 # 6348 <malloc+0x10f8>
  ...
  unlink("12345678901234");
    ...
    2744:	b1050513          	add	a0,a0,-1264 # 6250 <malloc+0x1000>
    ...
    2758:	b4450513          	add	a0,a0,-1212 # 6298 <malloc+0x1048>
    ...
    276c:	b9850513          	add	a0,a0,-1128 # 6300 <malloc+0x10b0>
    ...
    2780:	bfc50513          	add	a0,a0,-1028 # 6378 <malloc+0x1128>
    ...
    2794:	c4850513          	add	a0,a0,-952 # 63d8 <malloc+0x1188>
    ...
    27a8:	c8c50513          	add	a0,a0,-884 # 6430 <malloc+0x11e0>
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	c7c50513          	add	a0,a0,-900 # 6468 <malloc+0x1218>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	c6050513          	add	a0,a0,-928 # 6478 <malloc+0x1228>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29c0:	adc50513          	add	a0,a0,-1316 # 6498 <malloc+0x1248>
...
00000000000029ca <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a26:	aae50513          	add	a0,a0,-1362 # 64d0 <malloc+0x1280>
    ...
    2a3a:	ab250513          	add	a0,a0,-1358 # 64e8 <malloc+0x1298>
    ...
    2a4e:	ace50513          	add	a0,a0,-1330 # 6518 <malloc+0x12c8>
    ...
    2a62:	ae250513          	add	a0,a0,-1310 # 6540 <malloc+0x12f0>
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ac2:	15a50513          	add	a0,a0,346 # 5c18 <malloc+0x9c8>
    ...
    2ad6:	9fe50513          	add	a0,a0,-1538 # 64d0 <malloc+0x1280>
    ...
    2aea:	a7250513          	add	a0,a0,-1422 # 6558 <malloc+0x1308>
    ...
    2afe:	a1e50513          	add	a0,a0,-1506 # 6518 <malloc+0x12c8>
...
0000000000002b1c <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b78:	95c50513          	add	a0,a0,-1700 # 64d0 <malloc+0x1280>
    ...
    2b8c:	9f050513          	add	a0,a0,-1552 # 6578 <malloc+0x1328>
    ...
    2ba0:	9fc50513          	add	a0,a0,-1540 # 6598 <malloc+0x1348>
    ...
    2bb4:	a0050513          	add	a0,a0,-1536 # 65b0 <malloc+0x1360>
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	b2850513          	add	a0,a0,-1240 # 66f8 <malloc+0x14a8>
    2bd8:	1ec020ef          	jal	4dc4 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	9ec50513          	add	a0,a0,-1556 # 65c8 <malloc+0x1378>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bf4:	9f850513          	add	a0,a0,-1544 # 65e8 <malloc+0x1398>
  ...
  write(fd, "ff", 2);
    ...
    2c08:	af458593          	add	a1,a1,-1292 # 66f8 <malloc+0x14a8>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	9b250513          	add	a0,a0,-1614 # 65c8 <malloc+0x1378>
    2c1e:	1a6020ef          	jal	4dc4 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	a1a50513          	add	a0,a0,-1510 # 6640 <malloc+0x13f0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c3e:	a2e50513          	add	a0,a0,-1490 # 6668 <malloc+0x1418>
  ...
  write(fd, "FF", 2);
    ...
    2c52:	a4a58593          	add	a1,a1,-1462 # 6698 <malloc+0x1448>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	a3e50513          	add	a0,a0,-1474 # 66a0 <malloc+0x1450>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	92050513          	add	a0,a0,-1760 # 6668 <malloc+0x1418>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d60:	b2450513          	add	a0,a0,-1244 # 6880 <malloc+0x1630>
  ...
  if(unlink("dd") < 0){
    ...
    2ed2:	70250513          	add	a0,a0,1794 # 65d0 <malloc+0x1380>
    ...
    2ee6:	70e50513          	add	a0,a0,1806 # 65f0 <malloc+0x13a0>
    ...
    2efa:	71a50513          	add	a0,a0,1818 # 6610 <malloc+0x13c0>
    ...
    2f0e:	73e50513          	add	a0,a0,1854 # 6648 <malloc+0x13f8>
    ...
    2f22:	75a50513          	add	a0,a0,1882 # 6678 <malloc+0x1428>
    ...
    2f36:	77e50513          	add	a0,a0,1918 # 66b0 <malloc+0x1460>
    ...
    2f4a:	78a50513          	add	a0,a0,1930 # 66d0 <malloc+0x1480>
    ...
    2f5e:	7a650513          	add	a0,a0,1958 # 6700 <malloc+0x14b0>
    ...
    2f72:	7ba50513          	add	a0,a0,1978 # 6728 <malloc+0x14d8>
    ...
    2f86:	7c650513          	add	a0,a0,1990 # 6748 <malloc+0x14f8>
    ...
    2f9a:	7da50513          	add	a0,a0,2010 # 6770 <malloc+0x1520>
    ...
    2fae:	7ee50513          	add	a0,a0,2030 # 6798 <malloc+0x1548>
    ...
    2fc2:	80a50513          	add	a0,a0,-2038 # 67c8 <malloc+0x1578>
    ...
    2fd6:	82650513          	add	a0,a0,-2010 # 67f8 <malloc+0x15a8>
    ...
    2fea:	82a50513          	add	a0,a0,-2006 # 6810 <malloc+0x15c0>
    ...
    2ffe:	83650513          	add	a0,a0,-1994 # 6830 <malloc+0x15e0>
    ...
    3012:	84250513          	add	a0,a0,-1982 # 6850 <malloc+0x1600>
    ...
    3026:	86e50513          	add	a0,a0,-1938 # 6890 <malloc+0x1640>
    ...
    303a:	88a50513          	add	a0,a0,-1910 # 68c0 <malloc+0x1670>
    ...
    304e:	89650513          	add	a0,a0,-1898 # 68e0 <malloc+0x1690>
    ...
    3062:	8a250513          	add	a0,a0,-1886 # 6900 <malloc+0x16b0>
    ...
    3076:	8ae50513          	add	a0,a0,-1874 # 6920 <malloc+0x16d0>
    ...
    308a:	8ca50513          	add	a0,a0,-1846 # 6950 <malloc+0x1700>
    ...
    309e:	8de50513          	add	a0,a0,-1826 # 6978 <malloc+0x1728>
    ...
    30b2:	8f250513          	add	a0,a0,-1806 # 69a0 <malloc+0x1750>
    ...
    30c6:	90650513          	add	a0,a0,-1786 # 69c8 <malloc+0x1778>
    ...
    30da:	91250513          	add	a0,a0,-1774 # 69e8 <malloc+0x1798>
    ...
    30ee:	91e50513          	add	a0,a0,-1762 # 6a08 <malloc+0x17b8>
    ...
    3102:	93250513          	add	a0,a0,-1742 # 6a30 <malloc+0x17e0>
    ...
    3116:	93e50513          	add	a0,a0,-1730 # 6a50 <malloc+0x1800>
    ...
    312a:	94a50513          	add	a0,a0,-1718 # 6a70 <malloc+0x1820>
    ...
    313e:	95e50513          	add	a0,a0,-1698 # 6a98 <malloc+0x1848>
    ...
    3152:	5da50513          	add	a0,a0,1498 # 6728 <malloc+0x14d8>
    ...
    3166:	95650513          	add	a0,a0,-1706 # 6ab8 <malloc+0x1868>
    ...
    317a:	96250513          	add	a0,a0,-1694 # 6ad8 <malloc+0x1888>
    ...
    318e:	97e50513          	add	a0,a0,-1666 # 6b08 <malloc+0x18b8>
    ...
    31a2:	98a50513          	add	a0,a0,-1654 # 6b28 <malloc+0x18d8>
...
00000000000031b0 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    323c:	91050513          	add	a0,a0,-1776 # 6b48 <malloc+0x18f8>
    ...
    3250:	91450513          	add	a0,a0,-1772 # 6b60 <malloc+0x1910>
    ...
    3264:	91850513          	add	a0,a0,-1768 # 6b78 <malloc+0x1928>
    ...
    3278:	91c50513          	add	a0,a0,-1764 # 6b90 <malloc+0x1940>
    ...
    328c:	2b850513          	add	a0,a0,696 # 6540 <malloc+0x12f0>
    ...
    32a0:	91450513          	add	a0,a0,-1772 # 6bb0 <malloc+0x1960>
    ...
    32b4:	92850513          	add	a0,a0,-1752 # 6bd8 <malloc+0x1988>
    ...
    32c8:	93450513          	add	a0,a0,-1740 # 6bf8 <malloc+0x19a8>
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	93050513          	add	a0,a0,-1744 # 6c18 <malloc+0x19c8>
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	91c50513          	add	a0,a0,-1764 # 6c18 <malloc+0x19c8>
    3304:	2e1010ef          	jal	4de4 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	95450513          	add	a0,a0,-1708 # 6c60 <malloc+0x1a10>
  ...
  fd = open(".", 0);
    ...
    3390:	6e450513          	add	a0,a0,1764 # 5a70 <malloc+0x820>
    3394:	221010ef          	jal	4db4 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	05c58593          	add	a1,a1,92 # 53f8 <malloc+0x1a8>
  ...
  close(fd);
    ...
    33c4:	86050513          	add	a0,a0,-1952 # 6c20 <malloc+0x19d0>
    ...
    33d8:	86c50513          	add	a0,a0,-1940 # 6c40 <malloc+0x19f0>
    ...
    33ec:	88850513          	add	a0,a0,-1912 # 6c70 <malloc+0x1a20>
    ...
    3400:	87450513          	add	a0,a0,-1932 # 6c70 <malloc+0x1a20>
    ...
    3414:	88850513          	add	a0,a0,-1912 # 6c98 <malloc+0x1a48>
    ...
    3428:	89c50513          	add	a0,a0,-1892 # 6cc0 <malloc+0x1a70>
    ...
    343c:	8b050513          	add	a0,a0,-1872 # 6ce8 <malloc+0x1a98>
    ...
    3450:	8c450513          	add	a0,a0,-1852 # 6d10 <malloc+0x1ac0>
    ...
    3464:	8d050513          	add	a0,a0,-1840 # 6d30 <malloc+0x1ae0>
    ...
    3478:	8e450513          	add	a0,a0,-1820 # 6d58 <malloc+0x1b08>
...
0000000000003486 <iref>:
{
    ...
    34a4:	8d0a0a13          	add	s4,s4,-1840 # 6d70 <malloc+0x1b20>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	3d048493          	add	s1,s1,976 # 6878 <malloc+0x1628>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	0b0a8a93          	add	s5,s5,176 # 5560 <malloc+0x310>
    fd = open("xx", O_CREATE);
    34b8:	00003997          	auipc	s3,0x3
    34bc:	7b098993          	add	s3,s3,1968 # 6c68 <malloc+0x1a18>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	8b450513          	add	a0,a0,-1868 # 6d78 <malloc+0x1b28>
    ...
    34dc:	8b850513          	add	a0,a0,-1864 # 6d90 <malloc+0x1b40>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	05098993          	add	s3,s3,80 # 6590 <malloc+0x1340>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	82890913          	add	s2,s2,-2008 # 6d70 <malloc+0x1b20>
    chdir("..");
    3550:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3564:	fd850513          	add	a0,a0,-40 # 6538 <malloc+0x12e8>
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	81c50513          	add	a0,a0,-2020 # 6da8 <malloc+0x1b58>
  ...
  if(pid == 0){
    ...
    35ac:	80050513          	add	a0,a0,-2048 # 6da8 <malloc+0x1b58>
    ...
    35be:	80e50513          	add	a0,a0,-2034 # 6dc8 <malloc+0x1b78>
    ...
    35d2:	7e250513          	add	a0,a0,2018 # 6db0 <malloc+0x1b60>
    ...
    35e6:	63650513          	add	a0,a0,1590 # 5c18 <malloc+0x9c8>
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	7b250513          	add	a0,a0,1970 # 6df0 <malloc+0x1ba0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3662:	79250513          	add	a0,a0,1938 # 6df0 <malloc+0x1ba0>
  ...
  pause(10); // one second
    ...
    368a:	75250513          	add	a0,a0,1874 # 5dd8 <malloc+0xb88>
    ...
    369c:	75848493          	add	s1,s1,1880 # 6df0 <malloc+0x1ba0>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    ...
    36bc:	73850513          	add	a0,a0,1848 # 6df0 <malloc+0x1ba0>
...
00000000000036d0 <killstatus>:
{
  ...
  exit(0);
    ...
    3722:	4fa50513          	add	a0,a0,1274 # 5c18 <malloc+0x9c8>
    ...
    373c:	6c850513          	add	a0,a0,1736 # 6e00 <malloc+0x1bb0>
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	66c50513          	add	a0,a0,1644 # 5dd8 <malloc+0xb88>
  ...
  if(pid2 == 0)
    ...
    3792:	48a50513          	add	a0,a0,1162 # 5c18 <malloc+0x9c8>
  ...
  if(pid3 == 0){
    ...
    37c2:	c3a58593          	add	a1,a1,-966 # 53f8 <malloc+0x1a8>
    ...
    37e4:	43850513          	add	a0,a0,1080 # 5c18 <malloc+0x9c8>
    ...
    37f8:	62c50513          	add	a0,a0,1580 # 6e20 <malloc+0x1bd0>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	61450513          	add	a0,a0,1556 # 6e38 <malloc+0x1be8>
  ...
  printf("kill... ");
    ...
    384c:	60850513          	add	a0,a0,1544 # 6e50 <malloc+0x1c00>
  ...
  printf("wait... ");
    ...
    386a:	5fa50513          	add	a0,a0,1530 # 6e60 <malloc+0x1c10>
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	35250513          	add	a0,a0,850 # 5c18 <malloc+0x9c8>
    ...
    38de:	4c650513          	add	a0,a0,1222 # 5da0 <malloc+0xb50>
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	3e250513          	add	a0,a0,994 # 5d20 <malloc+0xad0>
    ...
    396c:	c8058593          	add	a1,a1,-896 # 75e8 <malloc+0x2398>
    ...
    3988:	4ec58593          	add	a1,a1,1260 # 6e70 <malloc+0x1c20>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	4a250513          	add	a0,a0,1186 # 6e78 <malloc+0x1c28>
  ...
  if(pid == 0){
    ...
    3a24:	4a850513          	add	a0,a0,1192 # 6ec8 <malloc+0x1c78>
    ...
    3a38:	47450513          	add	a0,a0,1140 # 6ea8 <malloc+0x1c58>
    ...
    3a4c:	1d050513          	add	a0,a0,464 # 5c18 <malloc+0x9c8>
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3aee:	40e50513          	add	a0,a0,1038 # 6ef8 <malloc+0x1ca8>
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	40a50513          	add	a0,a0,1034 # 6f18 <malloc+0x1cc8>
    3b16:	2ae010ef          	jal	4dc4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	3fa50513          	add	a0,a0,1018 # 6f18 <malloc+0x1cc8>
  ...
  if(pid == 0) {
    ...
    3b8c:	3a050513          	add	a0,a0,928 # 6f28 <malloc+0x1cd8>
    ...
    3ba0:	3b450513          	add	a0,a0,948 # 6f50 <malloc+0x1d00>
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	34c50513          	add	a0,a0,844 # 6f18 <malloc+0x1cc8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	36c50513          	add	a0,a0,876 # 6f70 <malloc+0x1d20>
  ...
  unlink("sharedfd");
    ...
    3c38:	2e450513          	add	a0,a0,740 # 6f18 <malloc+0x1cc8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	34250513          	add	a0,a0,834 # 6f98 <malloc+0x1d48>
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	32278793          	add	a5,a5,802 # 6fb0 <malloc+0x1d60>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	31e78793          	add	a5,a5,798 # 6fb8 <malloc+0x1d68>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	31a78793          	add	a5,a5,794 # 6fc0 <malloc+0x1d70>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	31678793          	add	a5,a5,790 # 6fc8 <malloc+0x1d78>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	f0450513          	add	a0,a0,-252 # 5c18 <malloc+0x9c8>
    ...
    3d7a:	f3a50513          	add	a0,a0,-198 # 5cb0 <malloc+0xa60>
    ...
    3d8c:	24850513          	add	a0,a0,584 # 6fd0 <malloc+0x1d80>
    ...
    3da6:	24650513          	add	a0,a0,582 # 6fe8 <malloc+0x1d98>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	1e650513          	add	a0,a0,486 # 6ff8 <malloc+0x1da8>
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	1a4b8b93          	add	s7,s7,420 # 7010 <malloc+0x1dc0>
  for(i = 0; i < N; i++){
    ...
    3eaa:	17250513          	add	a0,a0,370 # 7018 <malloc+0x1dc8>
    ...
    3ec0:	15450513          	add	a0,a0,340 # 7010 <malloc+0x1dc0>
  ...
  fd = open(".", 0);
    ...
    3ee8:	b8c50513          	add	a0,a0,-1140 # 5a70 <malloc+0x820>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	0e450513          	add	a0,a0,228 # 7038 <malloc+0x1de8>
    ...
    3f70:	0ec50513          	add	a0,a0,236 # 7058 <malloc+0x1e08>
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	0e850513          	add	a0,a0,232 # 7080 <malloc+0x1e30>
    ...
    3fb0:	c6c50513          	add	a0,a0,-916 # 5c18 <malloc+0x9c8>
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	fbe50513          	add	a0,a0,-66 # 70b8 <malloc+0x1e68>
    4102:	4c3000ef          	jal	4dc4 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	fae50513          	add	a0,a0,-82 # 70b8 <malloc+0x1e68>
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	f6250513          	add	a0,a0,-158 # 70b8 <malloc+0x1e68>
  ...
  for(i = 0; ; i++){
    ...
    41b6:	f1650513          	add	a0,a0,-234 # 70c8 <malloc+0x1e78>
    ...
    41ca:	f2250513          	add	a0,a0,-222 # 70e8 <malloc+0x1e98>
    ...
    41de:	f2e50513          	add	a0,a0,-210 # 7108 <malloc+0x1eb8>
    ...
    41f2:	f3a50513          	add	a0,a0,-198 # 7128 <malloc+0x1ed8>
    ...
    4206:	f4650513          	add	a0,a0,-186 # 7148 <malloc+0x1ef8>
    ...
    421a:	f4a50513          	add	a0,a0,-182 # 7160 <malloc+0x1f10>
  ...
  unlink("bigfile.dat");
    ...
    423c:	e8050513          	add	a0,a0,-384 # 70b8 <malloc+0x1e68>
    ...
    425c:	f2850513          	add	a0,a0,-216 # 7180 <malloc+0x1f30>
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	f2a50513          	add	a0,a0,-214 # 71a0 <malloc+0x1f50>
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	f0450513          	add	a0,a0,-252 # 71a0 <malloc+0x1f50>
  ...
  close(fd);
    ...
    42fa:	09250513          	add	a0,a0,146 # 5388 <malloc+0x138>
    42fe:	2af000ef          	jal	4dac <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	e9a50513          	add	a0,a0,-358 # 71a0 <malloc+0x1f50>
    ...
    4322:	e9250513          	add	a0,a0,-366 # 71b0 <malloc+0x1f60>
    ...
    433a:	e9a50513          	add	a0,a0,-358 # 71d0 <malloc+0x1f80>
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	e6250513          	add	a0,a0,-414 # 71f0 <malloc+0x1fa0>
    ...
    43a4:	e6850513          	add	a0,a0,-408 # 7208 <malloc+0x1fb8>
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	dda50513          	add	a0,a0,-550 # 71f0 <malloc+0x1fa0>
    ...
    442c:	e0850513          	add	a0,a0,-504 # 7230 <malloc+0x1fe0>
    ...
    4450:	df450513          	add	a0,a0,-524 # 7240 <malloc+0x1ff0>
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	db650513          	add	a0,a0,-586 # 7258 <malloc+0x2008>
  ...
  unsigned long bad[] = {
    ...
    44b8:	41c78793          	add	a5,a5,1052 # 78d0 <malloc+0x2680>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	078a0a13          	add	s4,s4,120 # 5560 <malloc+0x310>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	f80a8a93          	add	s5,s5,-128 # 5470 <malloc+0x220>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
...
0000000000004596 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	d0050513          	add	a0,a0,-768 # 72e0 <malloc+0x2090>
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	d0850513          	add	a0,a0,-760 # 7310 <malloc+0x20c0>
  ...
  if (p[1] != 0) {
    ...
    4632:	d1a50513          	add	a0,a0,-742 # 7348 <malloc+0x20f8>
  ...
  if ((uint64)p != -1) {
    ...
    4652:	d2250513          	add	a0,a0,-734 # 7370 <malloc+0x2120>
  ...
  if ((uint64)p != -1) {
    ...
    4672:	d2a50513          	add	a0,a0,-726 # 7398 <malloc+0x2148>
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	d2650513          	add	a0,a0,-730 # 73c8 <malloc+0x2178>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    46c2:	d1ac8c93          	add	s9,s9,-742 # 73d8 <malloc+0x2188>
    name[0] = 'f';
    ...
    472a:	cc250513          	add	a0,a0,-830 # 73e8 <malloc+0x2198>
  ...
  printf("fsfull test finished\n");
    ...
    4798:	c7450513          	add	a0,a0,-908 # 7408 <malloc+0x21b8>
    ...
    47e6:	c1650513          	add	a0,a0,-1002 # 73f8 <malloc+0x21a8>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	c1450513          	add	a0,a0,-1004 # 7420 <malloc+0x21d0>
  ...
  if(pid == 0) {
    ...
    4834:	c1850513          	add	a0,a0,-1000 # 7448 <malloc+0x21f8>
    ...
    4854:	be050513          	add	a0,a0,-1056 # 7430 <malloc+0x21e0>
    ...
    4870:	be450513          	add	a0,a0,-1052 # 7450 <malloc+0x2200>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	b9a50513          	add	a0,a0,-1126 # 7458 <malloc+0x2208>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    495a:	b1ac0c13          	add	s8,s8,-1254 # 7470 <malloc+0x2220>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4974:	b18d8d93          	add	s11,s11,-1256 # 7488 <malloc+0x2238>
      } else {
        ntests += n;
      }
    }
    ...
    497c:	b30d0d13          	add	s10,s10,-1232 # 74a8 <malloc+0x2258>
    ...
    49f6:	ae650513          	add	a0,a0,-1306 # 74d8 <malloc+0x2288>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a60:	a9458593          	add	a1,a1,-1388 # 74f0 <malloc+0x22a0>
  ...
  int continuous = 0;
    ...
    4ab4:	a5050513          	add	a0,a0,-1456 # 7500 <malloc+0x22b0>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4ad2:	a6250513          	add	a0,a0,-1438 # 7530 <malloc+0x22e0>
...
{
    4b84:	1141                	add	sp,sp,-16
    4b86:	e422                	sd	s0,8(sp)
    4b88:	0800                	add	s0,sp,16
  for(; *s; s++)
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    4bca:	89a6                	mv	s3,s1
    4bcc:	2485                	addw	s1,s1,1
    4bce:	0344d663          	bge	s1,s4,4bfa <gets+0x52>
    cc = read(0, &c, 1);
    4bd2:	4605                	li	a2,1
    4bd4:	faf40593          	add	a1,s0,-81
    4bd8:	4501                	li	a0,0
...
atoi(const char *s)
{
    4c52:	1141                	add	sp,sp,-16
    4c54:	e422                	sd	s0,8(sp)
    4c56:	0800                	add	s0,sp,16
  int n;

  n = 0;
  while('0' <= *s && *s <= '9')
    4c58:	00054683          	lbu	a3,0(a0)
    4c5c:	fd06879b          	addw	a5,a3,-48 # 3ffd0 <base+0x31318>
  ...
  n = 0;
    4c6c:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
    4c6e:	0705                	add	a4,a4,1 # 1000001 <base+0xff1349>
    4c70:	0025179b          	sllw	a5,a0,0x2
    4c74:	9fa9                	addw	a5,a5,a0
    4c76:	0017979b          	sllw	a5,a5,0x1
    4c7a:	9fb5                	addw	a5,a5,a3
    4c7c:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
    4c80:	00074683          	lbu	a3,0(a4)
    4c84:	fd06879b          	addw	a5,a3,-48
    4c88:	0ff7f793          	zext.b	a5,a5
    4c8c:	fef671e3          	bgeu	a2,a5,4c6e <atoi+0x1c>
  return n;
}
    4c90:	6422                	ld	s0,8(sp)
    4c92:	0141                	add	sp,sp,16
    4c94:	8082                	ret
  n = 0;
    4c96:	4501                	li	a0,0
...
{
    4c9a:	1141                	add	sp,sp,-16
    4c9c:	e422                	sd	s0,8(sp)
    4c9e:	0800                	add	s0,sp,16
  char *dst;
  const char *src;
  ...
  if (src > dst) {
    ...
    4ca8:	1602                	sll	a2,a2,0x20
    4caa:	9201                	srl	a2,a2,0x20
    4cac:	00c507b3          	add	a5,a0,a2
  dst = vdst;
    4cb0:	872a                	mv	a4,a0
      *dst++ = *src++;
    4cb2:	0585                	add	a1,a1,1
    4cb4:	0705                	add	a4,a4,1
  ...
  return vdst;
    ...
    4cd2:	fff6079b          	addw	a5,a2,-1
    4cd6:	1782                	sll	a5,a5,0x20
    4cd8:	9381                	srl	a5,a5,0x20
    4cda:	fff7c793          	not	a5,a5
    4cde:	97ba                	add	a5,a5,a4
      *--dst = *--src;
    4ce0:	15fd                	add	a1,a1,-1
    4ce2:	177d                	add	a4,a4,-1
...
{
    4cf2:	1141                	add	sp,sp,-16
    4cf4:	e422                	sd	s0,8(sp)
    4cf6:	0800                	add	s0,sp,16
  const char *p1 = s1, *p2 = s2;
  while (n-- > 0) {
    4cf8:	ca05                	beqz	a2,4d28 <memcmp+0x36>
    4cfa:	fff6069b          	addw	a3,a2,-1
    4cfe:	1682                	sll	a3,a3,0x20
    4d00:	9281                	srl	a3,a3,0x20
    4d02:	0685                	add	a3,a3,1
    ...
    p1++;
    4d12:	0505                	add	a0,a0,1
    p2++;
    4d14:	0585                	add	a1,a1,1
  while (n-- > 0) {
...
char *
sbrk(int n) {
    4d40:	1141                	add	sp,sp,-16
    4d42:	e406                	sd	ra,8(sp)
    4d44:	e022                	sd	s0,0(sp)
    4d46:	0800                	add	s0,sp,16
...
char *
sbrklazy(int n) {
    4d56:	1141                	add	sp,sp,-16
    4d58:	e406                	sd	ra,8(sp)
    4d5a:	e022                	sd	s0,0(sp)
    4d5c:	0800                	add	s0,sp,16
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  do{
    ...
    4e50:	b2c50513          	add	a0,a0,-1236 # 7978 <digits>
    4e54:	883e                	mv	a6,a5
    4e56:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    50e6:	896b8b93          	add	s7,s7,-1898 # 7978 <digits>
    50ea:	03c9d793          	srl	a5,s3,0x3c
    50ee:	97de                	add	a5,a5,s7
    50f0:	0007c583          	lbu	a1,0(a5)
    50f4:	855a                	mv	a0,s6
    50f6:	d1fff0ef          	jal	4e14 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    50fa:	0992                	sll	s3,s3,0x4
    50fc:	397d                	addw	s2,s2,-1
    ...
    5148:	78490913          	add	s2,s2,1924 # 78c8 <malloc+0x2678>
        for(; *s; s++)
...
{
    5172:	715d                	add	sp,sp,-80
    5174:	ec06                	sd	ra,24(sp)
    5176:	e822                	sd	s0,16(sp)
    5178:	1000                	add	s0,sp,32
...
{
    519c:	711d                	add	sp,sp,-96
    519e:	ec06                	sd	ra,24(sp)
    51a0:	e822                	sd	s0,16(sp)
    51a2:	1000                	add	s0,sp,32
...
free(void *ap)
{
    51ce:	1141                	add	sp,sp,-16
    51d0:	e422                	sd	s0,8(sp)
    51d2:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    51d4:	ff050693          	add	a3,a0,-16
    ...
    5204:	00e6ea63          	bltu	a3,a4,5218 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    521e:	02059813          	sll	a6,a1,0x20
    5222:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    5232:	02061593          	sll	a1,a2,0x20
    5236:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    5250:	7139                	add	sp,sp,-64
    5252:	fc06                	sd	ra,56(sp)
    5254:	f822                	sd	s0,48(sp)
    5256:	f426                	sd	s1,40(sp)
    5258:	ec4e                	sd	s3,24(sp)
    525a:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    525c:	02051493          	sll	s1,a0,0x20
    5260:	9081                	srl	s1,s1,0x20
    5262:	04bd                	add	s1,s1,15
    5264:	8091                	srl	s1,s1,0x4
    5266:	0014899b          	addw	s3,s1,1
    526a:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    52a0:	1f490913          	add	s2,s2,500 # 8490 <freep>
  if(p == SBRK_ERROR)
    52a4:	5afd                	li	s5,-1
    ...
    52b4:	a0878793          	add	a5,a5,-1528 # ecb8 <base>
  ...
  if(p == SBRK_ERROR)
    ...
    5316:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5318:	02071693          	sll	a3,a4,0x20
    531c:	01c6d713          	srl	a4,a3,0x1c
