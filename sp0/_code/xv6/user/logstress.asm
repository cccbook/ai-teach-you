   ...
   2:	0ea7df63          	bge	a5,a0,100 <main+0x100>
{
  ...
  3e:	93650513          	add	a0,a0,-1738 # 970 <malloc+0xfc>
  ...
  6a:	0304859b          	addw	a1,s1,48
  6e:	00001517          	auipc	a0,0x1
  72:	fa250513          	add	a0,a0,-94 # 1010 <buf>
  76:	110000ef          	jal	186 <memset>
  7a:	0fa00493          	li	s1,250
        if((n = write(fd, buf, SZ)) != SZ){
  7e:	00001997          	auipc	s3,0x1
  82:	f9298993          	add	s3,s3,-110 # 1010 <buf>
  ...
  b0:	8dc50513          	add	a0,a0,-1828 # 988 <malloc+0x114>
  ...
  c4:	8e050513          	add	a0,a0,-1824 # 9a0 <malloc+0x12c>
...
atoi(const char *s)
{
 ...
 294:	0025179b          	sllw	a5,a0,0x2
 298:	9fa9                	addw	a5,a5,a0
 29a:	0017979b          	sllw	a5,a5,0x1
 29e:	9fb5                	addw	a5,a5,a3
 2a0:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 2a4:	00074683          	lbu	a3,0(a4)
 2a8:	fd06879b          	addw	a5,a3,-48
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2cc:	1602                	sll	a2,a2,0x20
 2ce:	9201                	srl	a2,a2,0x20
 ...
 2f6:	fff6079b          	addw	a5,a2,-1
 2fa:	1782                	sll	a5,a5,0x20
 2fc:	9381                	srl	a5,a5,0x20
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 31e:	fff6069b          	addw	a3,a2,-1
 322:	1682                	sll	a3,a3,0x20
 324:	9281                	srl	a3,a3,0x20
 326:	0685                	add	a3,a3,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 474:	55050513          	add	a0,a0,1360 # 9c0 <digits>
 478:	883e                	mv	a6,a5
 47a:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 70a:	2bab8b93          	add	s7,s7,698 # 9c0 <digits>
 70e:	03c9d793          	srl	a5,s3,0x3c
 712:	97de                	add	a5,a5,s7
 714:	0007c583          	lbu	a1,0(a5)
 718:	855a                	mv	a0,s6
 71a:	d1fff0ef          	jal	438 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 71e:	0992                	sll	s3,s3,0x4
 720:	397d                	addw	s2,s2,-1
 ...
 76c:	25090913          	add	s2,s2,592 # 9b8 <malloc+0x144>
        for(; *s; s++)
...
free(void *ap)
{
 7f2:	1141                	add	sp,sp,-16
 7f4:	e422                	sd	s0,8(sp)
 7f6:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 7f8:	ff050693          	add	a3,a0,-16
 ...
 828:	00e6ea63          	bltu	a3,a4,83c <free+0x4a>
{
 ...
 840:	6390                	ld	a2,0(a5)
 842:	02059813          	sll	a6,a1,0x20
 846:	01c85713          	srl	a4,a6,0x1c
 ...
 850:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 854:	4790                	lw	a2,8(a5)
 856:	02061593          	sll	a1,a2,0x20
 85a:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 8c4:	74090913          	add	s2,s2,1856 # 1000 <freep>
  if(p == SBRK_ERROR)
 8c8:	5afd                	li	s5,-1
 ...
 8d8:	93478793          	add	a5,a5,-1740 # 1208 <base>
