...
ls(char *path)
{
  ...
  f8:	a1c50513          	add	a0,a0,-1508 # b10 <malloc+0x134>
 ...
 122:	9c258593          	add	a1,a1,-1598 # ae0 <malloc+0x104>
 126:	4509                	li	a0,2
 ...
 134:	9c858593          	add	a1,a1,-1592 # af8 <malloc+0x11c>
 138:	4509                	li	a0,2
 ...
 15e:	9c650513          	add	a0,a0,-1594 # b20 <malloc+0x144>
 ...
 1a2:	972a0a13          	add	s4,s4,-1678 # b10 <malloc+0x134>
        printf("ls: cannot stat %s\n", buf);
 1a6:	00001a97          	auipc	s5,0x1
 1aa:	952a8a93          	add	s5,s5,-1710 # af8 <malloc+0x11c>
...
main(int argc, char *argv[])
{
 ...
 25e:	8de50513          	add	a0,a0,-1826 # b38 <malloc+0x15c>
...
gets(char *buf, int max)
{
 ...
 354:	4b35                	li	s6,13
  for(i=0; i+1 < max; ){
 356:	89a6                	mv	s3,s1
 358:	2485                	addw	s1,s1,1
 35a:	0344d663          	bge	s1,s4,386 <gets+0x52>
    cc = read(0, &c, 1);
 35e:	4605                	li	a2,1
 360:	faf40593          	add	a1,s0,-81
 364:	4501                	li	a0,0
...
atoi(const char *s)
{
 ...
 3f8:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
 3fa:	0705                	add	a4,a4,1
 3fc:	0025179b          	sllw	a5,a0,0x2
 400:	9fa9                	addw	a5,a5,a0
 402:	0017979b          	sllw	a5,a5,0x1
 406:	9fb5                	addw	a5,a5,a3
 408:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 40c:	00074683          	lbu	a3,0(a4)
 410:	fd06879b          	addw	a5,a3,-48
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 434:	1602                	sll	a2,a2,0x20
 436:	9201                	srl	a2,a2,0x20
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 486:	fff6069b          	addw	a3,a2,-1
 48a:	1682                	sll	a3,a3,0x20
 48c:	9281                	srl	a3,a3,0x20
 48e:	0685                	add	a3,a3,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5dc:	57050513          	add	a0,a0,1392 # b48 <digits>
 5e0:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 872:	2dab8b93          	add	s7,s7,730 # b48 <digits>
 ...
 8d4:	27090913          	add	s2,s2,624 # b40 <malloc+0x164>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 a40:	5e478793          	add	a5,a5,1508 # 1020 <base>
