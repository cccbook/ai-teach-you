...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	0c650513          	add	a0,a0,198 # 1150 <malloc+0x102>
      92:	349000ef          	jal	bda <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	0ba50513          	add	a0,a0,186 # 1150 <malloc+0x102>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b0:	0ac50513          	add	a0,a0,172 # 1158 <malloc+0x10a>
  ...
  chdir("/");
      ...
      ca:	0ba50513          	add	a0,a0,186 # 1180 <malloc+0x132>
      ce:	315000ef          	jal	be2 <chdir>
      d2:	00001997          	auipc	s3,0x1
      d6:	0be98993          	add	s3,s3,190 # 1190 <malloc+0x142>
      da:	c489                	beqz	s1,e4 <go+0x70>
      dc:	00001997          	auipc	s3,0x1
      e0:	0ac98993          	add	s3,s3,172 # 1188 <malloc+0x13a>
  uint64 iters = 0;
      e4:	4481                	li	s1,0
  int fd = -1;
      e6:	5a7d                	li	s4,-1
      e8:	00001917          	auipc	s2,0x1
      ec:	37890913          	add	s2,s2,888 # 1460 <malloc+0x412>
    ...
    if(what == 1){
      ...
      fa:	0a250513          	add	a0,a0,162 # 1198 <malloc+0x14a>
    ...
    int what = rand() % 23;
     ...
     148:	06450513          	add	a0,a0,100 # 11a8 <malloc+0x15a>
     ...
     15a:	04250513          	add	a0,a0,66 # 1198 <malloc+0x14a>
     15e:	265000ef          	jal	bc2 <unlink>
     162:	b755                	j	106 <go+0x92>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     164:	00001517          	auipc	a0,0x1
     168:	fec50513          	add	a0,a0,-20 # 1150 <malloc+0x102>
     ...
     176:	04e50513          	add	a0,a0,78 # 11c0 <malloc+0x172>
     17a:	249000ef          	jal	bc2 <unlink>
      chdir("/");
     17e:	00001517          	auipc	a0,0x1
     182:	00250513          	add	a0,a0,2 # 1180 <malloc+0x132>
     186:	25d000ef          	jal	be2 <chdir>
     18a:	bfb5                	j	106 <go+0x92>
        printf("grind: chdir grindir failed\n");
     18c:	00001517          	auipc	a0,0x1
     190:	fcc50513          	add	a0,a0,-52 # 1158 <malloc+0x10a>
     ...
     1ac:	02050513          	add	a0,a0,32 # 11c8 <malloc+0x17a>
     ...
     1c6:	01650513          	add	a0,a0,22 # 11d8 <malloc+0x18a>
     ...
     2b4:	fb050513          	add	a0,a0,-80 # 1260 <malloc+0x212>
     ...
     2e6:	f7e50513          	add	a0,a0,-130 # 1260 <malloc+0x212>
     ...
     2f0:	083000ef          	jal	b72 <exit>
      ...
      sbrk(6011);
     2f4:	6505                	lui	a0,0x1
     2f6:	77b50513          	add	a0,a0,1915 # 177b <digits+0x2bb>
     ...
     32a:	f5a50513          	add	a0,a0,-166 # 1280 <malloc+0x232>
     ...
     34a:	f3250513          	add	a0,a0,-206 # 1278 <malloc+0x22a>
     ...
     360:	f0450513          	add	a0,a0,-252 # 1260 <malloc+0x212>
     ...
     372:	f2250513          	add	a0,a0,-222 # 1290 <malloc+0x242>
     ...
     3a4:	ec050513          	add	a0,a0,-320 # 1260 <malloc+0x212>
     ...
     3e4:	ec850513          	add	a0,a0,-312 # 12a8 <malloc+0x25a>
     ...
     400:	ec458593          	add	a1,a1,-316 # 12c0 <malloc+0x272>
     ...
     4c2:	da250513          	add	a0,a0,-606 # 1260 <malloc+0x212>
     ...
     4d4:	e4050513          	add	a0,a0,-448 # 1310 <malloc+0x2c2>
     ...
     4e4:	e3050513          	add	a0,a0,-464 # 1310 <malloc+0x2c2>
     ...
     4f8:	dcc58593          	add	a1,a1,-564 # 12c0 <malloc+0x272>
     ...
     532:	de250513          	add	a0,a0,-542 # 1310 <malloc+0x2c2>
     536:	68c000ef          	jal	bc2 <unlink>
     53a:	b6f1                	j	106 <go+0x92>
        printf("grind: create c failed\n");
     53c:	00001517          	auipc	a0,0x1
     540:	ddc50513          	add	a0,a0,-548 # 1318 <malloc+0x2ca>
     ...
     552:	de250513          	add	a0,a0,-542 # 1330 <malloc+0x2e2>
     ...
     564:	de850513          	add	a0,a0,-536 # 1348 <malloc+0x2fa>
     ...
     578:	dec50513          	add	a0,a0,-532 # 1360 <malloc+0x312>
     ...
     58a:	e0250513          	add	a0,a0,-510 # 1388 <malloc+0x33a>
     ...
     636:	df658593          	add	a1,a1,-522 # 1428 <malloc+0x3da>
     ...
     656:	dde50513          	add	a0,a0,-546 # 1430 <malloc+0x3e2>
     ...
     668:	c4458593          	add	a1,a1,-956 # 12a8 <malloc+0x25a>
     66c:	4509                	li	a0,2
     ...
     67c:	c3058593          	add	a1,a1,-976 # 12a8 <malloc+0x25a>
     680:	4509                	li	a0,2
     ...
     6bc:	cf858593          	add	a1,a1,-776 # 13b0 <malloc+0x362>
     6c0:	4509                	li	a0,2
     ...
     718:	b4c58593          	add	a1,a1,-1204 # 1260 <malloc+0x212>
     71c:	4509                	li	a0,2
     ...
     74c:	c6858593          	add	a1,a1,-920 # 13b0 <malloc+0x362>
     750:	4509                	li	a0,2
     ...
     77c:	c3858593          	add	a1,a1,-968 # 13b0 <malloc+0x362>
     780:	4509                	li	a0,2
     ...
     7cc:	a9858593          	add	a1,a1,-1384 # 1260 <malloc+0x212>
     7d0:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     7e8:	a9450513          	add	a0,a0,-1388 # 1278 <malloc+0x22a>
     7ec:	3d6000ef          	jal	bc2 <unlink>
  unlink("b");
     7f0:	00001517          	auipc	a0,0x1
     7f4:	a3850513          	add	a0,a0,-1480 # 1228 <malloc+0x1da>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     82a:	a3a50513          	add	a0,a0,-1478 # 1260 <malloc+0x212>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     84e:	629c                	ld	a5,0(a3)
     850:	6709                	lui	a4,0x2
     852:	c0970713          	add	a4,a4,-1015 # 1c09 <digits+0x749>
    ...
    printf("grind: fork failed\n");
     ...
     864:	a0050513          	add	a0,a0,-1536 # 1260 <malloc+0x212>
...
strlen(const char *s)
{
  ...
  for(n = 0; s[n]; n++)
     ...
     942:	0505                	add	a0,a0,1
     944:	87aa                	mv	a5,a0
     946:	86be                	mv	a3,a5
     948:	0785                	add	a5,a5,1
     94a:	fff7c703          	lbu	a4,-1(a5)
     94e:	ff65                	bnez	a4,946 <strlen+0x10>
     950:	40a6853b          	subw	a0,a3,a0
     954:	2505                	addw	a0,a0,1
    ;
  return n;
}
     956:	6422                	ld	s0,8(sp)
     958:	0141                	add	sp,sp,16
     95a:	8082                	ret
  for(n = 0; s[n]; n++)
     95c:	4501                	li	a0,0
...
memset(void *dst, int c, uint n)
{
  ...
  for(i = 0; i < n; i++){
     ...
     968:	87aa                	mv	a5,a0
     96a:	1602                	sll	a2,a2,0x20
     96c:	9201                	srl	a2,a2,0x20
...
atoi(const char *s)
{
     a50:	1141                	add	sp,sp,-16
     a52:	e422                	sd	s0,8(sp)
     a54:	0800                	add	s0,sp,16
  int n;

  n = 0;
  while('0' <= *s && *s <= '9')
     a56:	00054683          	lbu	a3,0(a0)
     a5a:	fd06879b          	addw	a5,a3,-48
  ...
  n = 0;
     a6a:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
     a6c:	0705                	add	a4,a4,1
     a6e:	0025179b          	sllw	a5,a0,0x2
     a72:	9fa9                	addw	a5,a5,a0
     a74:	0017979b          	sllw	a5,a5,0x1
     a78:	9fb5                	addw	a5,a5,a3
     a7a:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
     a7e:	00074683          	lbu	a3,0(a4)
     a82:	fd06879b          	addw	a5,a3,-48
     a86:	0ff7f793          	zext.b	a5,a5
     a8a:	fef671e3          	bgeu	a2,a5,a6c <atoi+0x1c>
  return n;
}
     a8e:	6422                	ld	s0,8(sp)
     a90:	0141                	add	sp,sp,16
     a92:	8082                	ret
  n = 0;
     a94:	4501                	li	a0,0
...
memmove(void *vdst, const void *vsrc, int n)
{
  ...
  if (src > dst) {
    ...
    while(n-- > 0)
     ...
     aa6:	1602                	sll	a2,a2,0x20
     aa8:	9201                	srl	a2,a2,0x20
     aaa:	00c507b3          	add	a5,a0,a2
  dst = vdst;
     aae:	872a                	mv	a4,a0
      *dst++ = *src++;
     ab0:	0585                	add	a1,a1,1
     ab2:	0705                	add	a4,a4,1
  ...
  return vdst;
    ...
    while(n-- > 0)
     ...
     ad0:	fff6079b          	addw	a5,a2,-1
     ad4:	1782                	sll	a5,a5,0x20
     ad6:	9381                	srl	a5,a5,0x20
     ad8:	fff7c793          	not	a5,a5
     adc:	97ba                	add	a5,a5,a4
      *--dst = *--src;
     ade:	15fd                	add	a1,a1,-1
     ae0:	177d                	add	a4,a4,-1
...
{
     af0:	1141                	add	sp,sp,-16
     af2:	e422                	sd	s0,8(sp)
     af4:	0800                	add	s0,sp,16
  const char *p1 = s1, *p2 = s2;
  while (n-- > 0) {
     af6:	ca05                	beqz	a2,b26 <memcmp+0x36>
     af8:	fff6069b          	addw	a3,a2,-1
     afc:	1682                	sll	a3,a3,0x20
     afe:	9281                	srl	a3,a3,0x20
     b00:	0685                	add	a3,a3,1
    ...
    p1++;
     b10:	0505                	add	a0,a0,1
    p2++;
     b12:	0585                	add	a1,a1,1
  while (n-- > 0) {
...
{
     b2a:	1141                	add	sp,sp,-16
     b2c:	e406                	sd	ra,8(sp)
     b2e:	e022                	sd	s0,0(sp)
     b30:	0800                	add	s0,sp,16
  return memmove(dst, src, n);
     b32:	f67ff0ef          	jal	a98 <memmove>
}
     b36:	60a2                	ld	ra,8(sp)
     b38:	6402                	ld	s0,0(sp)
     b3a:	0141                	add	sp,sp,16
     b3c:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     c4e:	87650513          	add	a0,a0,-1930 # 14c0 <digits>
     c52:	883e                	mv	a6,a5
     c54:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     ee4:	5e0b8b93          	add	s7,s7,1504 # 14c0 <digits>
     ee8:	03c9d793          	srl	a5,s3,0x3c
     eec:	97de                	add	a5,a5,s7
     eee:	0007c583          	lbu	a1,0(a5)
     ef2:	855a                	mv	a0,s6
     ef4:	d1fff0ef          	jal	c12 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ef8:	0992                	sll	s3,s3,0x4
     efa:	397d                	addw	s2,s2,-1
     ...
     f46:	51690913          	add	s2,s2,1302 # 1458 <malloc+0x40a>
        for(; *s; s++)
...
{
     f70:	715d                	add	sp,sp,-80
     f72:	ec06                	sd	ra,24(sp)
     f74:	e822                	sd	s0,16(sp)
     f76:	1000                	add	s0,sp,32
     f78:	e010                	sd	a2,0(s0)
     f7a:	e414                	sd	a3,8(s0)
...
free(void *ap)
{
     fcc:	1141                	add	sp,sp,-16
     fce:	e422                	sd	s0,8(sp)
     fd0:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
     fd2:	ff050693          	add	a3,a0,-16
    ...
    1002:	00e6ea63          	bltu	a3,a4,1016 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    101c:	02059813          	sll	a6,a1,0x20
    1020:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    1030:	02061593          	sll	a1,a2,0x20
    1034:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    104e:	7139                	add	sp,sp,-64
    1050:	fc06                	sd	ra,56(sp)
    1052:	f822                	sd	s0,48(sp)
    1054:	f426                	sd	s1,40(sp)
    1056:	ec4e                	sd	s3,24(sp)
    1058:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    105a:	02051493          	sll	s1,a0,0x20
    105e:	9081                	srl	s1,s1,0x20
    1060:	04bd                	add	s1,s1,15
    1062:	8091                	srl	s1,s1,0x4
    1064:	0014899b          	addw	s3,s1,1
    1068:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    109e:	f7690913          	add	s2,s2,-138 # 2010 <freep>
  if(p == SBRK_ERROR)
    10a2:	5afd                	li	s5,-1
  ...
  if(p == SBRK_ERROR)
    ...
    1114:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1116:	02071693          	sll	a3,a4,0x20
    111a:	01c6d713          	srl	a4,a3,0x1c
