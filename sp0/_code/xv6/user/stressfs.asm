...
main(int argc, char *argv[])
{
  ...
  1a:	95a78793          	add	a5,a5,-1702 # 970 <malloc+0x128>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	91450513          	add	a0,a0,-1772 # 940 <malloc+0xf8>
  ...
  60:	8fc50513          	add	a0,a0,-1796 # 958 <malloc+0x110>
...
//    printf(fd, "%d\n", i);
  ...
  9e:	8ce50513          	add	a0,a0,-1842 # 968 <malloc+0x120>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 448:	54450513          	add	a0,a0,1348 # 988 <digits>
 44c:	883e                	mv	a6,a5
 ...
 488:	fb840713          	add	a4,s0,-72
 48c:	00f704b3          	add	s1,a4,a5
 490:	fff70993          	add	s3,a4,-1
 494:	99be                	add	s3,s3,a5
 496:	37fd                	addw	a5,a5,-1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6de:	2aeb8b93          	add	s7,s7,686 # 988 <digits>
 ...
 740:	24490913          	add	s2,s2,580 # 980 <malloc+0x138>
        for(; *s; s++)
