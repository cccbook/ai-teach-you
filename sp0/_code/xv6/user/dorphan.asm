...
main(int argc, char **argv)
{
  ...
  10:	8f450513          	add	a0,a0,-1804 # 900 <malloc+0x106>
  14:	372000ef          	jal	386 <mkdir>
  18:	c919                	beqz	a0,2e <main+0x2e>
    printf("%s: mkdir dd failed\n", s);
  1a:	85a6                	mv	a1,s1
  1c:	00001517          	auipc	a0,0x1
  20:	8ec50513          	add	a0,a0,-1812 # 908 <malloc+0x10e>
  ...
  32:	8d250513          	add	a0,a0,-1838 # 900 <malloc+0x106>
  36:	358000ef          	jal	38e <chdir>
  3a:	c919                	beqz	a0,50 <main+0x50>
    printf("%s: chdir dd failed\n", s);
  3c:	85a6                	mv	a1,s1
  3e:	00001517          	auipc	a0,0x1
  42:	8e250513          	add	a0,a0,-1822 # 920 <malloc+0x126>
  ...
  54:	8e850513          	add	a0,a0,-1816 # 938 <malloc+0x13e>
  ...
  64:	8f850513          	add	a0,a0,-1800 # 958 <malloc+0x15e>
  ...
  7c:	8c850513          	add	a0,a0,-1848 # 940 <malloc+0x146>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3fa:	58a50513          	add	a0,a0,1418 # 980 <digits>
 3fe:	883e                	mv	a6,a5
 400:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 690:	2f4b8b93          	add	s7,s7,756 # 980 <digits>
 694:	03c9d793          	srl	a5,s3,0x3c
...
malloc(uint nbytes)
{
 ...
 85e:	9ae78793          	add	a5,a5,-1618 # 1208 <base>
