...
0000000080000060 <start>:
{
  ...
  asm volatile("csrw mepc, %0" : : "r" (x));
    ...
    80000084:	dbc78793          	add	a5,a5,-580 # 80000e3c <main>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80000190:	6d450513          	add	a0,a0,1748 # 8000f860 <cons>
  ...
  while(n > 0){
    ...
    8000019c:	6c848493          	add	s1,s1,1736 # 8000f860 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    800001a4:	75890913          	add	s2,s2,1880 # 8000f8f8 <cons+0x98>
  while(n > 0){
    ...
    800001dc:	68870713          	add	a4,a4,1672 # 8000f860 <cons>
    ...
    80000226:	63e50513          	add	a0,a0,1598 # 8000f860 <cons>
  ...
  release(&cons.lock);
    ...
    80000266:	5fe50513          	add	a0,a0,1534 # 8000f860 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    800002ba:	5aa50513          	add	a0,a0,1450 # 8000f860 <cons>
  ...
  release(&cons.lock);
    ...
    800002e0:	58450513          	add	a0,a0,1412 # 8000f860 <cons>
  ...
  switch(c){
    ...
    800002fe:	56670713          	add	a4,a4,1382 # 8000f860 <cons>
    ...
    80000324:	54078793          	add	a5,a5,1344 # 8000f860 <cons>
    ...
    800003ba:	4aa70713          	add	a4,a4,1194 # 8000f860 <cons>
    ...
    800003ee:	47678793          	add	a5,a5,1142 # 8000f860 <cons>
    ...
    8000041a:	4e250513          	add	a0,a0,1250 # 8000f8f8 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80000430:	bd458593          	add	a1,a1,-1068 # 80007000 <etext>
    80000434:	0000f517          	auipc	a0,0xf
    80000438:	42c50513          	add	a0,a0,1068 # 8000f860 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80000448:	58c78793          	add	a5,a5,1420 # 8001f9d0 <devsw>
...
printint(long long xx, int base, int sign)
{
  ...
  if(sign && (sign = (xx < 0)))
    ...
    80000478:	fc840693          	add	a3,s0,-56
  ...
  do {
    ...
    80000482:	29260613          	add	a2,a2,658 # 80007710 <digits>
    80000486:	883e                	mv	a6,a5
    80000488:	2785                	addw	a5,a5,1
...
printf(char *fmt, ...)
{
    800004fa:	7131                	add	sp,sp,-192
    800004fc:	fc86                	sd	ra,120(sp)
    800004fe:	f8a2                	sd	s0,112(sp)
    80000500:	e8d2                	sd	s4,80(sp)
    80000502:	0100                	add	s0,sp,128
  ...
  for(i = 0; (cx = fmt[i] & 0xff) != 0; i++){
    ...
    80000564:	3a850513          	add	a0,a0,936 # 8000f908 <pr>
  ...
  for(i = 0; (cx = fmt[i] & 0xff) != 0; i++){
    80000574:	0014899b          	addw	s3,s1,1
    ...
    i++;
    80000588:	0019849b          	addw	s1,s3,1
    c0 = fmt[i+0] & 0xff;
    ...
    80000622:	e47ff0ef          	jal	80000468 <printint>
      i += 1;
    80000626:	0029849b          	addw	s1,s3,2
    ...
    80000672:	df7ff0ef          	jal	80000468 <printint>
      i += 2;
    80000676:	0039849b          	addw	s1,s3,3
    8000067a:	bded                	j	80000574 <printf+0x7a>
      printint(va_arg(ap, uint32), 10, 0);
    8000067c:	f8843783          	ld	a5,-120(s0)
    80000680:	00878713          	add	a4,a5,8
    ...
    800006a8:	dc1ff0ef          	jal	80000468 <printint>
      i += 1;
    800006ac:	0029849b          	addw	s1,s3,2
    ...
    800006c4:	da5ff0ef          	jal	80000468 <printint>
      i += 2;
    800006c8:	0039849b          	addw	s1,s3,3
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    8000078c:	88090913          	add	s2,s2,-1920 # 80007008 <etext+0x8>
      for(; *s; s++)
  ...
  return 0;
    ...
    800007ce:	6129                	add	sp,sp,192
    800007d0:	8082                	ret
    release(&pr.lock);
    800007d2:	0000f517          	auipc	a0,0xf
    800007d6:	13650513          	add	a0,a0,310 # 8000f908 <pr>
...
panic(char *s)
{
  ...
  printf("panic: ");
    ...
    800007fc:	82050513          	add	a0,a0,-2016 # 80007018 <etext+0x18>
    80000800:	cfbff0ef          	jal	800004fa <printf>
  printf("%s\n", s);
    80000804:	85a6                	mv	a1,s1
    80000806:	00007517          	auipc	a0,0x7
    8000080a:	81a50513          	add	a0,a0,-2022 # 80007020 <etext+0x20>
...
printfinit(void)
{
    8000081c:	1141                	add	sp,sp,-16
    8000081e:	e406                	sd	ra,8(sp)
    80000820:	e022                	sd	s0,0(sp)
    80000822:	0800                	add	s0,sp,16
  initlock(&pr.lock, "pr");
    80000824:	00007597          	auipc	a1,0x7
    80000828:	80458593          	add	a1,a1,-2044 # 80007028 <etext+0x28>
    8000082c:	0000f517          	auipc	a0,0xf
    80000830:	0dc50513          	add	a0,a0,220 # 8000f908 <pr>
...
uartinit(void)
{
  ...
  initlock(&tx_lock, "uart");
    ...
    80000880:	7b458593          	add	a1,a1,1972 # 80007030 <etext+0x30>
    80000884:	0000f517          	auipc	a0,0xf
    80000888:	09c50513          	add	a0,a0,156 # 8000f920 <tx_lock>
    8000088c:	2c2000ef          	jal	80000b4e <initlock>
}
    80000890:	60a2                	ld	ra,8(sp)
    80000892:	6402                	ld	s0,0(sp)
    80000894:	0141                	add	sp,sp,16
    80000896:	8082                	ret
...
uartwrite(char buf[], int n)
{
  ...
  while(i < n){ 
    ...
    800008ca:	f7648493          	add	s1,s1,-138 # 8000783c <tx_busy>
      // wait for a UART transmit-complete interrupt
      // to set tx_busy to 0.
      sleep(&tx_chan, &tx_lock);
    800008ce:	0000f997          	auipc	s3,0xf
    800008d2:	05298993          	add	s3,s3,82 # 8000f920 <tx_lock>
    800008d6:	00007917          	auipc	s2,0x7
    800008da:	f6290913          	add	s2,s2,-158 # 80007838 <tx_chan>
    }   
  ...
  release(&tx_lock);
    ...
    80000918:	00c50513          	add	a0,a0,12 # 8000f920 <tx_lock>
...
uartputc_sync(int c)
{
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    ...
    80000950:	0715                	add	a4,a4,5 # 10000005 <_entry-0x6ffffffb>
    80000952:	00074783          	lbu	a5,0(a4)
    80000956:	0207f793          	and	a5,a5,32
...
uartgetc(void)
{
    ...
    8000098e:	0800                	add	s0,sp,16
  if(ReadReg(LSR) & LSR_RX_READY){
    80000990:	100007b7          	lui	a5,0x10000
    80000994:	0795                	add	a5,a5,5 # 10000005 <_entry-0x6ffffffb>
...
uartintr(void)
{
    800009b0:	1101                	add	sp,sp,-32
    800009b2:	ec06                	sd	ra,24(sp)
    800009b4:	e822                	sd	s0,16(sp)
    800009b6:	e426                	sd	s1,8(sp)
    800009b8:	1000                	add	s0,sp,32
  ReadReg(ISR); // acknowledge the interrupt
    800009ba:	100007b7          	lui	a5,0x10000
    800009be:	0789                	add	a5,a5,2 # 10000002 <_entry-0x6ffffffe>
    800009c0:	0007c783          	lbu	a5,0(a5)

  acquire(&tx_lock);
    800009c4:	0000f517          	auipc	a0,0xf
    800009c8:	f5c50513          	add	a0,a0,-164 # 8000f920 <tx_lock>
    800009cc:	202000ef          	jal	80000bce <acquire>
  if(ReadReg(LSR) & LSR_TX_IDLE){
    800009d0:	100007b7          	lui	a5,0x10000
    800009d4:	0795                	add	a5,a5,5 # 10000005 <_entry-0x6ffffffb>
    800009d6:	0007c783          	lbu	a5,0(a5)
    800009da:	0207f793          	and	a5,a5,32
  ...
  release(&tx_lock);
    ...
    800009e4:	f4050513          	add	a0,a0,-192 # 8000f920 <tx_lock>
  ...
  while(1){
    ...
    800009fc:	e4050513          	add	a0,a0,-448 # 80007838 <tx_chan>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    80000a50:	eec90913          	add	s2,s2,-276 # 8000f938 <kmem>
...
kalloc(void)
{
  ...
  if(r)
    ...
    80000b20:	e1c50513          	add	a0,a0,-484 # 8000f938 <kmem>
  ...
  return (void*)r;
    ...
    80000b3c:	6105                	add	sp,sp,32
    80000b3e:	8082                	ret
  release(&kmem.lock);
    80000b40:	0000f517          	auipc	a0,0xf
    80000b44:	df850513          	add	a0,a0,-520 # 8000f938 <kmem>
...
{
    80000b4e:	1141                	add	sp,sp,-16
    80000b50:	e422                	sd	s0,8(sp)
    80000b52:	0800                	add	s0,sp,16
  lk->name = name;
...
0000000080000bce <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    80000c02:	6105                	add	sp,sp,32
    80000c04:	8082                	ret
    panic("acquire");
    80000c06:	00006517          	auipc	a0,0x6
    80000c0a:	44250513          	add	a0,a0,1090 # 80007048 <etext+0x48>
...
0000000080000c66 <release>:
{
  ...
  pop_off();
    ...
    80000c92:	6105                	add	sp,sp,32
    80000c94:	8082                	ret
    panic("release");
    80000c96:	00006517          	auipc	a0,0x6
    80000c9a:	3da50513          	add	a0,a0,986 # 80007070 <etext+0x70>
...
memcmp(const void *v1, const void *v2, uint n)
{
  ...
  while(n-- > 0){
    ...
    80000ccc:	fff6069b          	addw	a3,a2,-1 # fff <_entry-0x7ffff001>
    80000cd0:	1682                	sll	a3,a3,0x20
    80000cd2:	9281                	srl	a3,a3,0x20
    80000cd4:	0685                	add	a3,a3,1
...
memmove(void *dst, const void *src, uint n)
{
  ...
  if(s < d && s + n > d){
    ...
    while(n-- > 0)
    80000d0a:	1602                	sll	a2,a2,0x20
    80000d0c:	9201                	srl	a2,a2,0x20
    80000d0e:	00c587b3          	add	a5,a1,a2
{
    80000d12:	872a                	mv	a4,a0
      *d++ = *s++;
    80000d14:	0585                	add	a1,a1,1
    80000d16:	0705                	add	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffde499>
  ...
  return dst;
    ...
    80000d28:	8082                	ret
  if(s < d && s + n > d){
    80000d2a:	02061693          	sll	a3,a2,0x20
    ...
    while(n-- > 0)
    80000d3a:	fff6079b          	addw	a5,a2,-1
    80000d3e:	1782                	sll	a5,a5,0x20
    80000d40:	9381                	srl	a5,a5,0x20
    80000d42:	fff7c793          	not	a5,a5
    80000d46:	97ba                	add	a5,a5,a4
      *--d = *--s;
    80000d48:	177d                	add	a4,a4,-1
    80000d4a:	16fd                	add	a3,a3,-1
...
{
    80000da4:	1141                	add	sp,sp,-16
    80000da6:	e422                	sd	s0,8(sp)
    80000da8:	0800                	add	s0,sp,16
  char *os;
  ...
  while(n-- > 0 && (*s++ = *t++) != 0)
    ...
    80000dae:	367d                	addw	a2,a2,-1
    80000db0:	02d05563          	blez	a3,80000dda <strncpy+0x36>
    80000db4:	0785                	add	a5,a5,1
  ...
  while(n-- > 0)
    ...
    80000dc6:	37fd                	addw	a5,a5,-1
    80000dc8:	00c05963          	blez	a2,80000dda <strncpy+0x36>
    *s++ = 0;
    80000dcc:	0705                	add	a4,a4,1
...
safestrcpy(char *s, const char *t, int n)
{
  ...
  if(n <= 0)
    ...
    80000dea:	fff6069b          	addw	a3,a2,-1
    80000dee:	1682                	sll	a3,a3,0x20
    80000df0:	9281                	srl	a3,a3,0x20
    80000df2:	96ae                	add	a3,a3,a1
    80000df4:	87aa                	mv	a5,a0
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
    80000df6:	00d58963          	beq	a1,a3,80000e08 <safestrcpy+0x28>
    80000dfa:	0585                	add	a1,a1,1
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000e4c:	9f870713          	add	a4,a4,-1544 # 80007840 <started>
  if(cpuid() == 0){
    ...
    80000e66:	23650513          	add	a0,a0,566 # 80007098 <etext+0x98>
  ...
  scheduler();        
    ...
    80000e8a:	1f250513          	add	a0,a0,498 # 80007078 <etext+0x78>
    80000e8e:	e6cff0ef          	jal	800004fa <printf>
    printf("xv6 kernel is booting\n");
    80000e92:	00006517          	auipc	a0,0x6
    80000e96:	1ee50513          	add	a0,a0,494 # 80007080 <etext+0x80>
    80000e9a:	e60ff0ef          	jal	800004fa <printf>
    printf("\n");
    80000e9e:	00006517          	auipc	a0,0x6
    80000ea2:	1da50513          	add	a0,a0,474 # 80007078 <etext+0x78>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80000f00:	83b1                	srl	a5,a5,0xc
    80000f02:	577d                	li	a4,-1
    80000f04:	177e                	sll	a4,a4,0x3f
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    80000f40:	17450513          	add	a0,a0,372 # 800070b0 <etext+0xb0>
    ...
    80000f5c:	00c4d793          	srl	a5,s1,0xc
    80000f60:	07aa                	sll	a5,a5,0xa
    80000f62:	0017e793          	or	a5,a5,1
    80000f66:	00f93023          	sd	a5,0(s2)
  for(int level = 2; level > 0; level--) {
    80000f6a:	3a5d                	addw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffde48f>
    80000f6c:	036a0063          	beq	s4,s6,80000f8c <walk+0x76>
    pte_t *pte = &pagetable[PX(level, va)];
    80000f70:	0149d933          	srl	s2,s3,s4
    80000f74:	1ff97913          	and	s2,s2,511
    80000f78:	090e                	sll	s2,s2,0x3
    80000f7a:	9926                	add	s2,s2,s1
    if(*pte & PTE_V) {
    80000f7c:	00093483          	ld	s1,0(s2)
    80000f80:	0014f793          	and	a5,s1,1
    80000f84:	d3f1                	beqz	a5,80000f48 <walk+0x32>
      pagetable = (pagetable_t)PTE2PA(*pte);
    80000f86:	80a9                	srl	s1,s1,0xa
    80000f88:	04b2                	sll	s1,s1,0xc
    80000f8a:	b7c5                	j	80000f6a <walk+0x54>
    }
  }
  return &pagetable[PX(0, va)];
    80000f8c:	00c9d513          	srl	a0,s3,0xc
    80000f90:	1ff57513          	and	a0,a0,511
    80000f94:	050e                	sll	a0,a0,0x3
    ...
    80000fba:	8082                	ret
{
  ...
  if((*pte & PTE_U) == 0)
    80000fce:	0117f693          	and	a3,a5,17
  ...
  if((*pte & PTE_U) == 0)
    ...
    80000fde:	0141                	add	sp,sp,16
    80000fe0:	8082                	ret
  pa = PTE2PA(*pte);
    80000fe2:	83a9                	srl	a5,a5,0xa
    80000fe4:	00c79513          	sll	a0,a5,0xc
  return pa;
...
mappages(pagetable_t pagetable, uint64 va, uint64 size, uint64 pa, int perm)
{
    ...
    80001002:	0880                	add	s0,sp,80
  uint64 a, last;
  pte_t *pte;

  if((va % PGSIZE) != 0)
    80001004:	03459793          	sll	a5,a1,0x34
  ...
  if((size % PGSIZE) != 0)
    8000100e:	03461793          	sll	a5,a2,0x34
  ...
  a = va;
    ...
    *pte = PA2PTE(pa) | perm | PTE_V;
    ...
    80001038:	8b85                	and	a5,a5,1
    8000103a:	ef95                	bnez	a5,80001076 <mappages+0x88>
    *pte = PA2PTE(pa) | perm | PTE_V;
    8000103c:	80b1                	srl	s1,s1,0xc
    8000103e:	04aa                	sll	s1,s1,0xa
    80001040:	0164e4b3          	or	s1,s1,s6
    80001044:	0014e493          	or	s1,s1,1
    ...
    80001056:	06650513          	add	a0,a0,102 # 800070b8 <etext+0xb8>
    8000105a:	f86ff0ef          	jal	800007e0 <panic>
    panic("mappages: size not aligned");
    8000105e:	00006517          	auipc	a0,0x6
    80001062:	07a50513          	add	a0,a0,122 # 800070d8 <etext+0xd8>
    80001066:	f7aff0ef          	jal	800007e0 <panic>
    panic("mappages: size");
    8000106a:	00006517          	auipc	a0,0x6
    8000106e:	08e50513          	add	a0,a0,142 # 800070f8 <etext+0xf8>
    80001072:	f6eff0ef          	jal	800007e0 <panic>
      panic("mappages: remap");
    80001076:	00006517          	auipc	a0,0x6
    8000107a:	09250513          	add	a0,a0,146 # 80007108 <etext+0x108>
...
{
    8000109e:	1141                	add	sp,sp,-16
    800010a0:	e406                	sd	ra,8(sp)
    800010a2:	e022                	sd	s0,0(sp)
    800010a4:	0800                	add	s0,sp,16
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    800010be:	05e50513          	add	a0,a0,94 # 80007118 <etext+0x118>
...
00000000800010c6 <kvmmake>:
{
  ...
  kvmmap(kpgtbl, TRAMPOLINE, (uint64)trampoline, PGSIZE, PTE_R | PTE_X);
    ...
    80001152:	eb260613          	add	a2,a2,-334 # 80006000 <_trampoline>
    80001156:	040005b7          	lui	a1,0x4000
    8000115a:	15fd                	add	a1,a1,-1 # 3ffffff <_entry-0x7c000001>
    8000115c:	05b2                	sll	a1,a1,0xc
...
{
    800011ba:	7139                	add	sp,sp,-64
    800011bc:	fc06                	sd	ra,56(sp)
    800011be:	f822                	sd	s0,48(sp)
    800011c0:	0080                	add	s0,sp,64
  uint64 a;
  pte_t *pte;

  if((va % PGSIZE) != 0)
    800011c2:	03459793          	sll	a5,a1,0x34
  ...
  for(a = va; a < va + npages*PGSIZE; a += PGSIZE){
    ...
    800011f8:	f2c50513          	add	a0,a0,-212 # 80007120 <etext+0x120>
...
uvmdealloc(pagetable_t pagetable, uint64 oldsz, uint64 newsz)
{
  ...
  if(PGROUNDUP(newsz) < PGROUNDUP(oldsz)){
    ...
    80001258:	17fd                	add	a5,a5,-1 # fff <_entry-0x7ffff001>
    ...
    80001288:	08b66f63          	bltu	a2,a1,80001326 <uvmalloc+0x9e>
{
    ...
    80001298:	0080                	add	s0,sp,64
    8000129a:	8aaa                	mv	s5,a0
    8000129c:	8a32                	mv	s4,a2
  oldsz = PGROUNDUP(oldsz);
    8000129e:	6785                	lui	a5,0x1
    800012a0:	17fd                	add	a5,a5,-1 # fff <_entry-0x7ffff001>
...
uvmfree(pagetable_t pagetable, uint64 sz)
{
  ...
  freewalk(pagetable);
    ...
    800013a8:	6105                	add	sp,sp,32
    800013aa:	8082                	ret
    uvmunmap(pagetable, 0, PGROUNDUP(sz)/PGSIZE, 1);
    800013ac:	6785                	lui	a5,0x1
    800013ae:	17fd                	add	a5,a5,-1 # fff <_entry-0x7ffff001>
    800013b0:	95be                	add	a1,a1,a5
    800013b2:	4685                	li	a3,1
    800013b4:	00c5d613          	srl	a2,a1,0xc
    ...
    800013c0:	ce49                	beqz	a2,8000145a <uvmcopy+0x9a>
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800013f8:	00177793          	and	a5,a4,1
    800013fc:	d3fd                	beqz	a5,800013e2 <uvmcopy+0x22>
      continue;   // physical page hasn't been allocated
    pa = PTE2PA(*pte);
    800013fe:	00a75593          	srl	a1,a4,0xa
    80001402:	00c59b93          	sll	s7,a1,0xc
    flags = PTE_FLAGS(*pte);
    80001406:	3ff77913          	and	s2,a4,1023
    if((mem = kalloc()) == 0)
 ...
 err:
  uvmunmap(new, 0, i / PGSIZE, 1);
    ...
    80001432:	00c4d613          	srl	a2,s1,0xc
...
{
    8000145e:	1141                	add	sp,sp,-16
    80001460:	e406                	sd	ra,8(sp)
    80001462:	e022                	sd	s0,0(sp)
    80001464:	0800                	add	s0,sp,16
  pte_t *pte;
  ...
  *pte &= ~PTE_U;
    ...
    80001470:	9bbd                	and	a5,a5,-17
    80001472:	e11c                	sd	a5,0(a0)
}
    80001474:	60a2                	ld	ra,8(sp)
    80001476:	6402                	ld	s0,0(sp)
    80001478:	0141                	add	sp,sp,16
    8000147a:	8082                	ret
    panic("uvmclear");
    8000147c:	00006517          	auipc	a0,0x6
    80001480:	ccc50513          	add	a0,a0,-820 # 80007148 <etext+0x148>
    ...
    80001488:	c6dd                	beqz	a3,80001536 <copyinstr+0xae>
{
  ...
  if(got_null){
    ...
    800014cc:	6161                	add	sp,sp,80
    800014ce:	8082                	ret
    800014d0:	fff90713          	add	a4,s2,-1 # fff <_entry-0x7ffff001>
...
proc_mapstacks(pagetable_t kpgtbl)
{
    ...
    80001766:	0080                	add	s0,sp,64
    80001768:	8a2a                	mv	s4,a0
  struct proc *p;
  
  for(p = proc; p < &proc[NPROC]; p++) {
    8000176a:	0000e497          	auipc	s1,0xe
    8000176e:	61e48493          	add	s1,s1,1566 # 8000fd88 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
    ...
    80001778:	fa590913          	add	s2,s2,-91 # 4fa4fa5 <_entry-0x7b05b05b>
    8000177c:	0932                	sll	s2,s2,0xc
    8000177e:	fa590913          	add	s2,s2,-91
    80001782:	0932                	sll	s2,s2,0xc
    80001784:	fa590913          	add	s2,s2,-91
    80001788:	0932                	sll	s2,s2,0xc
    8000178a:	fa590913          	add	s2,s2,-91
    8000178e:	040009b7          	lui	s3,0x4000
    80001792:	19fd                	add	s3,s3,-1 # 3ffffff <_entry-0x7c000001>
    80001794:	09b2                	sll	s3,s3,0xc
  for(p = proc; p < &proc[NPROC]; p++) {
    80001796:	00014a97          	auipc	s5,0x14
    8000179a:	ff2a8a93          	add	s5,s5,-14 # 80015788 <tickslock>
    char *pa = kalloc();
    ...
    800017aa:	858d                	sra	a1,a1,0x3
    800017ac:	032585b3          	mul	a1,a1,s2
    800017b0:	2585                	addw	a1,a1,1
    800017b2:	00d5959b          	sllw	a1,a1,0xd
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    800017c4:	16848493          	add	s1,s1,360
    ...
    800017dc:	6121                	add	sp,sp,64
    800017de:	8082                	ret
      panic("kalloc");
    800017e0:	00006517          	auipc	a0,0x6
    800017e4:	97850513          	add	a0,a0,-1672 # 80007158 <etext+0x158>
...
procinit(void)
{
    ...
    800017fe:	0080                	add	s0,sp,64
  struct proc *p;
  
  initlock(&pid_lock, "nextpid");
    80001800:	00006597          	auipc	a1,0x6
    80001804:	96058593          	add	a1,a1,-1696 # 80007160 <etext+0x160>
    80001808:	0000e517          	auipc	a0,0xe
    8000180c:	15050513          	add	a0,a0,336 # 8000f958 <pid_lock>
    80001810:	b3eff0ef          	jal	80000b4e <initlock>
  initlock(&wait_lock, "wait_lock");
    80001814:	00006597          	auipc	a1,0x6
    80001818:	95458593          	add	a1,a1,-1708 # 80007168 <etext+0x168>
    8000181c:	0000e517          	auipc	a0,0xe
    80001820:	15450513          	add	a0,a0,340 # 8000f970 <wait_lock>
    80001824:	b2aff0ef          	jal	80000b4e <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    80001828:	0000e497          	auipc	s1,0xe
    8000182c:	56048493          	add	s1,s1,1376 # 8000fd88 <proc>
      initlock(&p->lock, "proc");
    80001830:	00006b17          	auipc	s6,0x6
    80001834:	948b0b13          	add	s6,s6,-1720 # 80007178 <etext+0x178>
      p->state = UNUSED;
      p->kstack = KSTACK((int) (p - proc));
    80001838:	8aa6                	mv	s5,s1
    8000183a:	04fa5937          	lui	s2,0x4fa5
    8000183e:	fa590913          	add	s2,s2,-91 # 4fa4fa5 <_entry-0x7b05b05b>
    80001842:	0932                	sll	s2,s2,0xc
    80001844:	fa590913          	add	s2,s2,-91
    80001848:	0932                	sll	s2,s2,0xc
    8000184a:	fa590913          	add	s2,s2,-91
    8000184e:	0932                	sll	s2,s2,0xc
    80001850:	fa590913          	add	s2,s2,-91
    80001854:	040009b7          	lui	s3,0x4000
    80001858:	19fd                	add	s3,s3,-1 # 3ffffff <_entry-0x7c000001>
    8000185a:	09b2                	sll	s3,s3,0xc
  for(p = proc; p < &proc[NPROC]; p++) {
    8000185c:	00014a17          	auipc	s4,0x14
    80001860:	f2ca0a13          	add	s4,s4,-212 # 80015788 <tickslock>
      initlock(&p->lock, "proc");
    ...
    80001874:	878d                	sra	a5,a5,0x3
    80001876:	032787b3          	mul	a5,a5,s2
    8000187a:	2785                	addw	a5,a5,1 # fffffffffffff001 <end+0xffffffff7ffde499>
    8000187c:	00d7979b          	sllw	a5,a5,0xd
    80001880:	40f987b3          	sub	a5,s3,a5
    80001884:	e0bc                	sd	a5,64(s1)
  for(p = proc; p < &proc[NPROC]; p++) {
    80001886:	16848493          	add	s1,s1,360
...
cpuid()
{
    800018a2:	1141                	add	sp,sp,-16
    800018a4:	e422                	sd	s0,8(sp)
    800018a6:	0800                	add	s0,sp,16
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    800018e6:	07670713          	add	a4,a4,118 # 8000f958 <pid_lock>
...
forkret(void)
{
  ...
  if (first) {
    ...
    80001932:	85250513          	add	a0,a0,-1966 # 80007180 <etext+0x180>
    80001936:	fca43823          	sd	a0,-48(s0)
    8000193a:	fc043c23          	sd	zero,-40(s0)
    8000193e:	fd040593          	add	a1,s0,-48
  ...
  uint64 satp = MAKE_SATP(p->pagetable);
    ...
    8000195a:	8131                	srl	a0,a0,0xc
  uint64 trampoline_userret = TRAMPOLINE + (userret - trampoline);
    8000195c:	04000737          	lui	a4,0x4000
    80001960:	177d                	add	a4,a4,-1 # 3ffffff <_entry-0x7c000001>
    80001962:	0732                	sll	a4,a4,0xc
    80001964:	00004797          	auipc	a5,0x4
    80001968:	73878793          	add	a5,a5,1848 # 8000609c <userret>
    8000196c:	00004697          	auipc	a3,0x4
    80001970:	69468693          	add	a3,a3,1684 # 80006000 <_trampoline>
    80001974:	8f95                	sub	a5,a5,a3
    80001976:	97ba                	add	a5,a5,a4
  ((void (*)(uint64))trampoline_userret)(satp);
    80001978:	577d                	li	a4,-1
    8000197a:	177e                	sll	a4,a4,0x3f
...
00000000800019d4 <proc_pagetable>:
{
  ...
  if(mappages(pagetable, TRAMPOLINE, PGSIZE,
    ...
    800019f0:	61468693          	add	a3,a3,1556 # 80006000 <_trampoline>
    800019f4:	6605                	lui	a2,0x1
    800019f6:	040005b7          	lui	a1,0x4000
    800019fa:	15fd                	add	a1,a1,-1 # 3ffffff <_entry-0x7c000001>
    800019fc:	05b2                	sll	a1,a1,0xc
  ...
  if(mappages(pagetable, TRAPFRAME, PGSIZE,
    ...
    80001a12:	15fd                	add	a1,a1,-1 # 1ffffff <_entry-0x7e000001>
    80001a14:	05b6                	sll	a1,a1,0xd
    ...
    80001a42:	15fd                	add	a1,a1,-1 # 3ffffff <_entry-0x7c000001>
    80001a44:	05b2                	sll	a1,a1,0xc
...
0000000080001a58 <proc_freepagetable>:
{
  ...
  uvmunmap(pagetable, TRAMPOLINE, 1, 0);
    ...
    80001a70:	15fd                	add	a1,a1,-1 # 3ffffff <_entry-0x7c000001>
    80001a72:	05b2                	sll	a1,a1,0xc
    80001a74:	f46ff0ef          	jal	800011ba <uvmunmap>
  uvmunmap(pagetable, TRAPFRAME, 1, 0);
    80001a78:	4681                	li	a3,0
    80001a7a:	4605                	li	a2,1
    80001a7c:	020005b7          	lui	a1,0x2000
    80001a80:	15fd                	add	a1,a1,-1 # 1ffffff <_entry-0x7e000001>
    80001a82:	05b6                	sll	a1,a1,0xd
...
0000000080001aee <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001afe:	28e48493          	add	s1,s1,654 # 8000fd88 <proc>
    80001b02:	00014917          	auipc	s2,0x14
    80001b06:	c8690913          	add	s2,s2,-890 # 80015788 <tickslock>
    acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80001b1a:	16848493          	add	s1,s1,360
  ...
  memset(&p->context, 0, sizeof(p->context));
    ...
    80001b4c:	06048513          	add	a0,s1,96
    80001b50:	952ff0ef          	jal	80000ca2 <memset>
  p->context.ra = (uint64)forkret;
    80001b54:	00000797          	auipc	a5,0x0
    80001b58:	daa78793          	add	a5,a5,-598 # 800018fe <forkret>
...
0000000080001b94 <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    80001bb0:	5e450513          	add	a0,a0,1508 # 80007190 <etext+0x190>
...
0000000080001bd0 <growproc>:
{
  ...
  if(n > 0){
    ...
    80001bf2:	17fd                	add	a5,a5,-1 # 1ffffff <_entry-0x7e000001>
    80001bf4:	07b6                	sll	a5,a5,0xd
...
0000000080001c32 <kfork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
    ...
    80001c78:	12068693          	add	a3,a3,288
    ...
    80001c90:	02078793          	add	a5,a5,32
    80001c94:	02070713          	add	a4,a4,32
    80001c98:	fed792e3          	bne	a5,a3,80001c7c <kfork+0x4a>
  np->trapframe->a0 = 0;
    80001c9c:	058a3783          	ld	a5,88(s4)
    80001ca0:	0607b823          	sd	zero,112(a5)
  for(i = 0; i < NOFILE; i++)
    80001ca4:	0d0a8493          	add	s1,s5,208
    80001ca8:	0d0a0913          	add	s2,s4,208
    80001cac:	150a8993          	add	s3,s5,336
  ...
  for(i = 0; i < NOFILE; i++)
    80001cc4:	04a1                	add	s1,s1,8
    80001cc6:	0921                	add	s2,s2,8
  ...
  safestrcpy(np->name, p->name, sizeof(p->name));
    ...
    80001ce8:	158a8593          	add	a1,s5,344
    80001cec:	158a0513          	add	a0,s4,344
  ...
  acquire(&wait_lock);
    ...
    80001d02:	c7248493          	add	s1,s1,-910 # 8000f970 <wait_lock>
...
0000000080001d40 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001db0:	029a3823          	sd	s1,48(s4)
        swtch(&c->context, &p->context);
    80001db4:	06048593          	add	a1,s1,96
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001dea:	fa248493          	add	s1,s1,-94 # 8000fd88 <proc>
      if(p->state == RUNNABLE) {
...
0000000080001df2 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001e16:	b4670713          	add	a4,a4,-1210 # 8000f958 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001e3c:	b2090913          	add	s2,s2,-1248 # 8000f958 <pid_lock>
    80001e40:	2781                	sext.w	a5,a5
    80001e42:	079e                	sll	a5,a5,0x7
...
wakeup(void *chan)
{
    ...
    80001f34:	0080                	add	s0,sp,64
    80001f36:	8a2a                	mv	s4,a0
  struct proc *p;

  for(p = proc; p < &proc[NPROC]; p++) {
    80001f38:	0000e497          	auipc	s1,0xe
    80001f3c:	e5048493          	add	s1,s1,-432 # 8000fd88 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f48:	84490913          	add	s2,s2,-1980 # 80015788 <tickslock>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80001f54:	16848493          	add	s1,s1,360
    ...
    80001f8a:	6121                	add	sp,sp,64
    80001f8c:	8082                	ret

0000000080001f8e <reparent>:
{
    80001f8e:	7179                	add	sp,sp,-48
    ...
    80001f9c:	1800                	add	s0,sp,48
    80001f9e:	892a                	mv	s2,a0
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80001fa0:	0000e497          	auipc	s1,0xe
    80001fa4:	de848493          	add	s1,s1,-536 # 8000fd88 <proc>
      pp->parent = initproc;
    80001fa8:	00006a17          	auipc	s4,0x6
    80001fac:	8a8a0a13          	add	s4,s4,-1880 # 80007850 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80001fb0:	00013997          	auipc	s3,0x13
    80001fb4:	7d898993          	add	s3,s3,2008 # 80015788 <tickslock>
...
0000000080001fe4 <kexit>:
{
  ...
  if(p == initproc)
    ...
    80002004:	0d050493          	add	s1,a0,208
    80002008:	15050913          	add	s2,a0,336
    8000200c:	00a79f63          	bne	a5,a0,8000202a <kexit+0x46>
    panic("init exiting");
    80002010:	00005517          	auipc	a0,0x5
    80002014:	1d050513          	add	a0,a0,464 # 800071e0 <etext+0x1e0>
  ...
  acquire(&wait_lock);
    ...
    80002048:	92c48493          	add	s1,s1,-1748 # 8000f970 <wait_lock>
  ...
  panic("zombie exit");
    ...
    8000207e:	17650513          	add	a0,a0,374 # 800071f0 <etext+0x1f0>
...
kkill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000209a:	cf248493          	add	s1,s1,-782 # 8000fd88 <proc>
    8000209e:	00013997          	auipc	s3,0x13
    800020a2:	6ea98993          	add	s3,s3,1770 # 80015788 <tickslock>
    acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    800020b8:	16848493          	add	s1,s1,360
...
000000008000213a <kwait>:
{
  ...
  acquire(&wait_lock);
    ...
    8000215e:	81650513          	add	a0,a0,-2026 # 8000f970 <wait_lock>
    ...
    80002170:	61c98993          	add	s3,s3,1564 # 80015788 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002174:	0000dc17          	auipc	s8,0xd
    80002178:	7fcc0c13          	add	s8,s8,2044 # 8000f970 <wait_lock>
    ...
    80002188:	02c48613          	add	a2,s1,44
    ...
    800021aa:	7ca50513          	add	a0,a0,1994 # 8000f970 <wait_lock>
    ...
    8000221e:	b6e48493          	add	s1,s1,-1170 # 8000fd88 <proc>
    80002222:	b7e1                	j	800021ea <kwait+0xb0>
      release(&wait_lock);
    80002224:	0000d517          	auipc	a0,0xd
    80002228:	74c50513          	add	a0,a0,1868 # 8000f970 <wait_lock>
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800022e2:	d9a50513          	add	a0,a0,-614 # 80007078 <etext+0x78>
    800022e6:	a14fe0ef          	jal	800004fa <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    800022ea:	0000e497          	auipc	s1,0xe
    800022ee:	bf648493          	add	s1,s1,-1034 # 8000fee0 <proc+0x158>
    800022f2:	00013917          	auipc	s2,0x13
    800022f6:	5ee90913          	add	s2,s2,1518 # 800158e0 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    ...
    80002300:	f0498993          	add	s3,s3,-252 # 80007200 <etext+0x200>
    printf("%d %s %s", p->pid, state, p->name);
    80002304:	00005a97          	auipc	s5,0x5
    80002308:	f04a8a93          	add	s5,s5,-252 # 80007208 <etext+0x208>
    printf("\n");
    8000230c:	00005a17          	auipc	s4,0x5
    80002310:	d6ca0a13          	add	s4,s4,-660 # 80007078 <etext+0x78>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    80002314:	00005b97          	auipc	s7,0x5
    80002318:	414b8b93          	add	s7,s7,1044 # 80007728 <states.0>
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    8000232e:	16848493          	add	s1,s1,360
    ...
    80002344:	02079713          	sll	a4,a5,0x20
    80002348:	01d75793          	srl	a5,a4,0x1d
...
trapinit(void)
{
    800023d6:	1141                	add	sp,sp,-16
    800023d8:	e406                	sd	ra,8(sp)
    800023da:	e022                	sd	s0,0(sp)
    800023dc:	0800                	add	s0,sp,16
  initlock(&tickslock, "time");
    800023de:	00005597          	auipc	a1,0x5
    800023e2:	e6a58593          	add	a1,a1,-406 # 80007248 <etext+0x248>
    800023e6:	00013517          	auipc	a0,0x13
    800023ea:	3a250513          	add	a0,a0,930 # 80015788 <tickslock>
...
trapinithart(void)
{
    ...
    800023fe:	0800                	add	s0,sp,16
  asm volatile("csrw stvec, %0" : : "r" (x));
    80002400:	00003797          	auipc	a5,0x3
    80002404:	f5078793          	add	a5,a5,-176 # 80005350 <kernelvec>
    80002408:	10579073          	csrw	stvec,a5
  w_stvec((uint64)kernelvec);
}
    8000240c:	6422                	ld	s0,8(sp)
    8000240e:	0141                	add	sp,sp,16
    80002410:	8082                	ret
...
prepare_return(void)
{
  ...
  uint64 trampoline_uservec = TRAMPOLINE + (uservec - trampoline);
    ...
    8000242c:	177d                	add	a4,a4,-1 # 3ffffff <_entry-0x7c000001>
    8000242e:	0732                	sll	a4,a4,0xc
    80002430:	00004797          	auipc	a5,0x4
    80002434:	bd078793          	add	a5,a5,-1072 # 80006000 <_trampoline>
    80002438:	00004697          	auipc	a3,0x4
    8000243c:	bc868693          	add	a3,a3,-1080 # 80006000 <_trampoline>
  ...
  p->trapframe->kernel_trap = (uint64)usertrap;
    ...
    80002460:	0f870713          	add	a4,a4,248 # 80002554 <usertrap>
  ...
  x &= ~SSTATUS_SPP; // clear SPP to 0 for user mode
    80002470:	eff7f793          	and	a5,a5,-257
  x |= SSTATUS_SPIE; // enable interrupts in user mode
    80002474:	0207e793          	or	a5,a5,32
  asm volatile("csrw sstatus, %0" : : "r" (x));
...
clockintr()
{
  ...
  asm volatile("csrw 0x14d, %0" : : "r" (x));
    ...
    800024ba:	2d248493          	add	s1,s1,722 # 80015788 <tickslock>
    800024be:	8526                	mv	a0,s1
    800024c0:	f0efe0ef          	jal	80000bce <acquire>
    ticks++;
    800024c4:	00005517          	auipc	a0,0x5
    800024c8:	39450513          	add	a0,a0,916 # 80007858 <ticks>
...
devintr()
{
  ...
  if(scause == 0x8000000000000009L){
    ...
    80002538:	d1c50513          	add	a0,a0,-740 # 80007250 <etext+0x250>
...
0000000080002554 <usertrap>:
{
  ...
  if(r_scause() == 8){
    ...
    800025b4:	ce050513          	add	a0,a0,-800 # 80007290 <etext+0x290>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    800025c8:	cfc50513          	add	a0,a0,-772 # 800072c0 <etext+0x2c0>
    ...
    800025dc:	c9850513          	add	a0,a0,-872 # 80007270 <etext+0x270>
  ...
  uint64 satp = MAKE_SATP(p->pagetable);
    ...
    80002610:	8131                	srl	a0,a0,0xc
    80002612:	57fd                	li	a5,-1
    80002614:	17fe                	sll	a5,a5,0x3f
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80002634:	164d                	add	a2,a2,-13 # ff3 <_entry-0x7ffff00d>
...
0000000080002662 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800026b0:	c3c50513          	add	a0,a0,-964 # 800072e8 <etext+0x2e8>
    800026b4:	92cfe0ef          	jal	800007e0 <panic>
    panic("kerneltrap: interrupts enabled");
    800026b8:	00005517          	auipc	a0,0x5
    800026bc:	c5850513          	add	a0,a0,-936 # 80007310 <etext+0x310>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    800026d2:	c6250513          	add	a0,a0,-926 # 80007330 <etext+0x330>
    800026d6:	e25fd0ef          	jal	800004fa <printf>
    panic("kerneltrap");
    800026da:	00005517          	auipc	a0,0x5
    800026de:	c7e50513          	add	a0,a0,-898 # 80007358 <etext+0x358>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80002708:	048a                	sll	s1,s1,0x2
    8000270a:	00005717          	auipc	a4,0x5
    8000270e:	04e70713          	add	a4,a4,78 # 80007758 <states.0+0x30>
  ...
  panic("argraw");
    ...
    8000274a:	c2250513          	add	a0,a0,-990 # 80007368 <etext+0x368>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    80002862:	37fd                	addw	a5,a5,-1
    80002864:	4751                	li	a4,20
    80002866:	00f76f63          	bltu	a4,a5,80002884 <syscall+0x40>
    8000286a:	00369713          	sll	a4,a3,0x3
    8000286e:	00005797          	auipc	a5,0x5
    80002872:	f0278793          	add	a5,a5,-254 # 80007770 <syscalls>
    ...
    80002884:	15848613          	add	a2,s1,344
    80002888:	588c                	lw	a1,48(s1)
    8000288a:	00005517          	auipc	a0,0x5
    8000288e:	ae650513          	add	a0,a0,-1306 # 80007370 <etext+0x370>
...
sys_exit(void)
{
    ...
    800028ae:	1000                	add	s0,sp,32
  int n;
  argint(0, &n);
    800028b0:	fec40593          	add	a1,s0,-20
...
sys_getpid(void)
{
    800028cc:	1141                	add	sp,sp,-16
    800028ce:	e406                	sd	ra,8(sp)
    800028d0:	e022                	sd	s0,0(sp)
    800028d2:	0800                	add	s0,sp,16
  return myproc()->pid;
...
sys_fork(void)
{
    800028e2:	1141                	add	sp,sp,-16
    800028e4:	e406                	sd	ra,8(sp)
    800028e6:	e022                	sd	s0,0(sp)
    800028e8:	0800                	add	s0,sp,16
  return kfork();
...
sys_wait(void)
{
    ...
    800028fc:	1000                	add	s0,sp,32
  uint64 p;
  argaddr(0, &p);
    800028fe:	fe840593          	add	a1,s0,-24
...
sys_sbrk(void)
{
    ...
    80002920:	1800                	add	s0,sp,48
  uint64 addr;
  int t;
  int n;

  argint(0, &n);
    80002922:	fd840593          	add	a1,s0,-40
    80002926:	4501                	li	a0,0
    80002928:	eb5ff0ef          	jal	800027dc <argint>
  argint(1, &t);
    8000292c:	fdc40593          	add	a1,s0,-36
  ...
  if(t == SBRK_EAGER || n < 0) {
    ...
    80002958:	177d                	add	a4,a4,-1 # 1ffffff <_entry-0x7e000001>
    8000295a:	0736                	sll	a4,a4,0xd
...
sys_pause(void)
{
    80002994:	7139                	add	sp,sp,-64
    80002996:	fc06                	sd	ra,56(sp)
    80002998:	f822                	sd	s0,48(sp)
    8000299a:	f04a                	sd	s2,32(sp)
    8000299c:	0080                	add	s0,sp,64
  int n;
  uint ticks0;

  argint(0, &n);
    8000299e:	fcc40593          	add	a1,s0,-52
  ...
  acquire(&tickslock);
    ...
    800029b4:	dd850513          	add	a0,a0,-552 # 80015788 <tickslock>
  ...
  while(ticks - ticks0 < n){
    ...
    800029d2:	dba98993          	add	s3,s3,-582 # 80015788 <tickslock>
    800029d6:	00005497          	auipc	s1,0x5
    800029da:	e8248493          	add	s1,s1,-382 # 80007858 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002a06:	d8650513          	add	a0,a0,-634 # 80015788 <tickslock>
  ...
  return 0;
    ...
    80002a24:	d6850513          	add	a0,a0,-664 # 80015788 <tickslock>
...
sys_kill(void)
{
    80002a34:	1101                	add	sp,sp,-32
    80002a36:	ec06                	sd	ra,24(sp)
    80002a38:	e822                	sd	s0,16(sp)
    80002a3a:	1000                	add	s0,sp,32
  int pid;

  argint(0, &pid);
    80002a3c:	fec40593          	add	a1,s0,-20
...
sys_uptime(void)
{
    ...
    80002a5e:	1000                	add	s0,sp,32
  uint xticks;

  acquire(&tickslock);
    80002a60:	00013517          	auipc	a0,0x13
    80002a64:	d2850513          	add	a0,a0,-728 # 80015788 <tickslock>
  ...
  release(&tickslock);
    ...
    80002a78:	d1450513          	add	a0,a0,-748 # 80015788 <tickslock>
    80002a7c:	9eafe0ef          	jal	80000c66 <release>
  return xticks;
}
    80002a80:	02049513          	sll	a0,s1,0x20
    80002a84:	9101                	srl	a0,a0,0x20
...
binit(void)
{
    ...
    80002a9e:	1800                	add	s0,sp,48
  struct buf *b;

  initlock(&bcache.lock, "bcache");
    80002aa0:	00005597          	auipc	a1,0x5
    80002aa4:	8f058593          	add	a1,a1,-1808 # 80007390 <etext+0x390>
    80002aa8:	00013517          	auipc	a0,0x13
    80002aac:	cf850513          	add	a0,a0,-776 # 800157a0 <bcache>
    80002ab0:	89efe0ef          	jal	80000b4e <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80002ab4:	0001b797          	auipc	a5,0x1b
    80002ab8:	cec78793          	add	a5,a5,-788 # 8001d7a0 <bcache+0x8000>
    80002abc:	0001b717          	auipc	a4,0x1b
    80002ac0:	f4c70713          	add	a4,a4,-180 # 8001da08 <bcache+0x8268>
    80002ac4:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002ac8:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002acc:	00013497          	auipc	s1,0x13
    80002ad0:	cec48493          	add	s1,s1,-788 # 800157b8 <bcache+0x18>
    ...
    80002adc:	8c0a0a13          	add	s4,s4,-1856 # 80007398 <etext+0x398>
    b->next = bcache.head.next;
    ...
    80002aec:	01048513          	add	a0,s1,16
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002afe:	45848493          	add	s1,s1,1112
...
bread(uint dev, uint blockno)
{
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80002b40:	ecc78793          	add	a5,a5,-308 # 8001da08 <bcache+0x8268>
    ...
    80002b60:	2785                	addw	a5,a5,1
    80002b62:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    80002b64:	00013517          	auipc	a0,0x13
    80002b68:	c3c50513          	add	a0,a0,-964 # 800157a0 <bcache>
    80002b6c:	8fafe0ef          	jal	80000c66 <release>
      acquiresleep(&b->lock);
    80002b70:	01048513          	add	a0,s1,16
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002b86:	e8678793          	add	a5,a5,-378 # 8001da08 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002b9e:	80650513          	add	a0,a0,-2042 # 800073a0 <etext+0x3a0>
    ...
    80002bba:	bea50513          	add	a0,a0,-1046 # 800157a0 <bcache>
    80002bbe:	8a8fe0ef          	jal	80000c66 <release>
      acquiresleep(&b->lock);
    80002bc2:	01048513          	add	a0,s1,16
...
bwrite(struct buf *b)
{
    ...
    80002bf4:	1000                	add	s0,sp,32
    80002bf6:	84aa                	mv	s1,a0
  if(!holdingsleep(&b->lock))
    80002bf8:	0541                	add	a0,a0,16
  ...
  virtio_disk_rw(b, 1);
    ...
    80002c16:	7a650513          	add	a0,a0,1958 # 800073b8 <etext+0x3b8>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002c42:	b6250513          	add	a0,a0,-1182 # 800157a0 <bcache>
    80002c46:	f89fd0ef          	jal	80000bce <acquire>
  b->refcnt--;
    80002c4a:	40bc                	lw	a5,64(s1)
    80002c4c:	37fd                	addw	a5,a5,-1
  ...
  if (b->refcnt == 0) {
    ...
    80002c64:	b4078793          	add	a5,a5,-1216 # 8001d7a0 <bcache+0x8000>
    80002c68:	2b87b703          	ld	a4,696(a5)
    80002c6c:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002c6e:	0001b717          	auipc	a4,0x1b
    80002c72:	d9a70713          	add	a4,a4,-614 # 8001da08 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002c96:	6105                	add	sp,sp,32
    80002c98:	8082                	ret
    panic("brelse");
    80002c9a:	00004517          	auipc	a0,0x4
    80002c9e:	72650513          	add	a0,a0,1830 # 800073c0 <etext+0x3c0>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002cea:	aba50513          	add	a0,a0,-1350 # 800157a0 <bcache>
    80002cee:	ee1fd0ef          	jal	80000bce <acquire>
  b->refcnt--;
    80002cf2:	40bc                	lw	a5,64(s1)
    80002cf4:	37fd                	addw	a5,a5,-1
    80002cf6:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    80002cf8:	00013517          	auipc	a0,0x13
    80002cfc:	aa850513          	add	a0,a0,-1368 # 800157a0 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    80002d1c:	00d5d59b          	srlw	a1,a1,0xd
  ...
  bi = b % BPB;
  m = 1 << (bi % 8);
    80002d2e:	0074f713          	and	a4,s1,7
    80002d32:	4785                	li	a5,1
    80002d34:	00e797bb          	sllw	a5,a5,a4
  if((bp->data[bi/8] & m) == 0)
    80002d38:	14ce                	sll	s1,s1,0x33
    80002d3a:	90d9                	srl	s1,s1,0x36
...
0000000080002d7a <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80002da8:	0bcb0b13          	add	s6,s6,188 # 8001de60 <sb>
  ...
  memset(bp->data, 0, BSIZE);
    ...
    80002dda:	05850513          	add	a0,a0,88
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    bp = bread(dev, BBLOCK(b, sb));
    80002e20:	41fad79b          	sraw	a5,s5,0x1f
    80002e24:	0137d79b          	srlw	a5,a5,0x13
    80002e28:	015787bb          	addw	a5,a5,s5
    80002e2c:	40d7d79b          	sraw	a5,a5,0xd
    ...
    80002e48:	fca4f1e3          	bgeu	s1,a0,80002e0a <balloc+0x90>
      m = 1 << (bi % 8);
    80002e4c:	00777693          	and	a3,a4,7
    80002e50:	00d996bb          	sllw	a3,s3,a3
      if((bp->data[bi/8] & m) == 0){  // Is block free?
    80002e54:	41f7579b          	sraw	a5,a4,0x1f
    80002e58:	01d7d79b          	srlw	a5,a5,0x1d
    80002e5c:	9fb9                	addw	a5,a5,a4
    80002e5e:	4037d79b          	sraw	a5,a5,0x3
    ...
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80002e70:	2705                	addw	a4,a4,1
    80002e72:	2485                	addw	s1,s1,1
  ...
  printf("balloc: out of blocks\n");
    ...
    80002e8e:	55650513          	add	a0,a0,1366 # 800073e0 <etext+0x3e0>
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    ...
    80002eb0:	02059793          	sll	a5,a1,0x20
    80002eb4:	01e7d593          	srl	a1,a5,0x1e
  ...
  bn -= NDIRECT;
    80002ed8:	ff45849b          	addw	s1,a1,-12
  ...
  if(bn < NINDIRECT){
    ...
    a = (uint*)bp->data;
    80002f14:	05850793          	add	a5,a0,88
    if((addr = a[bn]) == 0){
    80002f18:	02049713          	sll	a4,s1,0x20
    80002f1c:	01e75593          	srl	a1,a4,0x1e
  ...
  panic("bmap: out of range");
    ...
    80002f66:	49650513          	add	a0,a0,1174 # 800073f8 <etext+0x3f8>
...
0000000080002f6e <iget>:
{
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002fc8:	ebc50513          	add	a0,a0,-324 # 8001de80 <itable>
  ...
  release(&itable.lock);
    ...
    80002ff4:	e9050513          	add	a0,a0,-368 # 8001de80 <itable>
    ...
    80003012:	40250513          	add	a0,a0,1026 # 80007410 <etext+0x410>
...
000000008000301a <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    8000302c:	3f858593          	add	a1,a1,1016 # 80007420 <etext+0x420>
    80003030:	0001b517          	auipc	a0,0x1b
    80003034:	e5050513          	add	a0,a0,-432 # 8001de80 <itable>
    80003038:	b17fd0ef          	jal	80000b4e <initlock>
  for(i = 0; i < NINODE; i++) {
    8000303c:	0001b497          	auipc	s1,0x1b
    80003040:	e6c48493          	add	s1,s1,-404 # 8001dea8 <itable+0x28>
    80003044:	0001d997          	auipc	s3,0x1d
    80003048:	8f498993          	add	s3,s3,-1804 # 8001f938 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    8000304c:	00004917          	auipc	s2,0x4
    80003050:	3dc90913          	add	s2,s2,988 # 80007428 <etext+0x428>
    80003054:	85ca                	mv	a1,s2
    80003056:	8526                	mv	a0,s1
    80003058:	5bb000ef          	jal	80003e12 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
    8000305c:	08848493          	add	s1,s1,136
    ...
    8000306e:	6145                	add	sp,sp,48
    80003070:	8082                	ret

0000000080003072 <ialloc>:
{
    80003072:	7139                	add	sp,sp,-64
    80003074:	fc06                	sd	ra,56(sp)
    80003076:	f822                	sd	s0,48(sp)
    80003078:	0080                	add	s0,sp,64
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    8000309e:	dc6a0a13          	add	s4,s4,-570 # 8001de60 <sb>
    800030a2:	00495593          	srl	a1,s2,0x4
    ...
    800030b4:	05850993          	add	s3,a0,88
    800030b8:	00f97793          	and	a5,s2,15
    800030bc:	079a                	sll	a5,a5,0x6
  ...
  printf("ialloc: no inodes\n");
    ...
    800030e8:	34c50513          	add	a0,a0,844 # 80007430 <etext+0x430>
...
000000008000312e <iupdate>:
{
    ...
    80003138:	1000                	add	s0,sp,32
    8000313a:	84aa                	mv	s1,a0
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    8000313c:	415c                	lw	a5,4(a0)
    8000313e:	0047d79b          	srlw	a5,a5,0x4
  ...
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003154:	05850793          	add	a5,a0,88
    80003158:	40d8                	lw	a4,4(s1)
    8000315a:	8b3d                	and	a4,a4,15
    8000315c:	071a                	sll	a4,a4,0x6
  ...
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    ...
    80003188:	05048593          	add	a1,s1,80
    8000318c:	00c78513          	add	a0,a5,12
...
00000000800031ac <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    800031bc:	cc850513          	add	a0,a0,-824 # 8001de80 <itable>
    800031c0:	a0ffd0ef          	jal	80000bce <acquire>
  ip->ref++;
    800031c4:	449c                	lw	a5,8(s1)
    800031c6:	2785                	addw	a5,a5,1
    800031c8:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    800031ca:	0001b517          	auipc	a0,0x1b
    800031ce:	cb650513          	add	a0,a0,-842 # 8001de80 <itable>
...
00000000800031e2 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003232:	05850593          	add	a1,a0,88
    80003236:	40dc                	lw	a5,4(s1)
    80003238:	8bbd                	and	a5,a5,15
    8000323a:	079a                	sll	a5,a5,0x6
    ...
    80003266:	05b1                	add	a1,a1,12
    80003268:	05048513          	add	a0,s1,80
...
0000000080003290 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    800032c8:	19c50513          	add	a0,a0,412 # 80007460 <etext+0x460>
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    800032e0:	05050493          	add	s1,a0,80
    800032e4:	08050913          	add	s2,a0,128
    800032e8:	a021                	j	800032f0 <itrunc+0x20>
    800032ea:	0491                	add	s1,s1,4
  ...
  iupdate(ip);
    ...
    8000332c:	05850493          	add	s1,a0,88
    80003330:	45850913          	add	s2,a0,1112
    80003334:	a021                	j	8000333c <itrunc+0x6c>
    80003336:	0491                	add	s1,s1,4
...
0000000080003364 <iput>:
{
  ...
  ip->ref--;
    ...
    80003386:	37fd                	addw	a5,a5,-1
    80003388:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    8000338a:	0001b517          	auipc	a0,0x1b
    8000338e:	af650513          	add	a0,a0,-1290 # 8001de80 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    800033e0:	aa450513          	add	a0,a0,-1372 # 8001de80 <itable>
    ...
    80003416:	0ae7ff63          	bgeu	a5,a4,800034d4 <ireclaim+0xc8>
{
  ...
  for (int inum = 1; inum < sb.ninodes; inum++) {
    ...
    struct buf *bp = bread(dev, IBLOCK(inum, sb));
    8000348e:	0044d593          	srl	a1,s1,0x4
    ...
    800034a0:	05850793          	add	a5,a0,88
    800034a4:	00f9f713          	and	a4,s3,15
    800034a8:	071a                	sll	a4,a4,0x6
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800034f2:	97298993          	add	s3,s3,-1678 # 8001de60 <sb>
    800034f6:	02000613          	li	a2,32
    800034fa:	05850593          	add	a1,a0,88
  ...
  if(sb.magic != FSMAGIC)
    ...
    80003512:	04078793          	add	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    80003516:	02f71363          	bne	a4,a5,8000353c <fsinit+0x66>
  initlog(dev, &sb);
    8000351a:	0001b597          	auipc	a1,0x1b
    8000351e:	94658593          	add	a1,a1,-1722 # 8001de60 <sb>
  ...
  ireclaim(dev);
    ...
    80003540:	f4c50513          	add	a0,a0,-180 # 80007488 <etext+0x488>
...
{
    80003548:	1141                	add	sp,sp,-16
    8000354a:	e422                	sd	s0,8(sp)
    8000354c:	0800                	add	s0,sp,16
  st->dev = ip->dev;
    ...
    80003574:	0ed7eb63          	bltu	a5,a3,8000366a <readi+0xf8>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    800035be:	020d1d93          	sll	s11,s10,0x20
    800035c2:	020ddd93          	srl	s11,s11,0x20
    800035c6:	05890613          	add	a2,s2,88
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    uint addr = bmap(ip, off/BSIZE);
    800035ee:	00a4d59b          	srlw	a1,s1,0xa
    ...
    m = min(n - tot, BSIZE - off%BSIZE);
    80003608:	3ff4f713          	and	a4,s1,1023
    ...
    80003670:	10d7e063          	bltu	a5,a3,80003770 <writei+0x102>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    800036ba:	020d1d93          	sll	s11,s10,0x20
    800036be:	020ddd93          	srl	s11,s11,0x20
    800036c2:	05848513          	add	a0,s1,88
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    uint addr = bmap(ip, off/BSIZE);
    800036f0:	00a9559b          	srlw	a1,s2,0xa
    ...
    m = min(n - tot, BSIZE - off%BSIZE);
    8000370a:	3ff97713          	and	a4,s2,1023
...
{
    8000377c:	1141                	add	sp,sp,-16
    8000377e:	e406                	sd	ra,8(sp)
    80003780:	e022                	sd	s0,0(sp)
    80003782:	0800                	add	s0,sp,16
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800037c0:	ce450513          	add	a0,a0,-796 # 800074a0 <etext+0x4a0>
    800037c4:	81cfd0ef          	jal	800007e0 <panic>
      panic("dirlookup read");
    800037c8:	00004517          	auipc	a0,0x4
    800037cc:	cf050513          	add	a0,a0,-784 # 800074b8 <etext+0x4b8>
    800037d0:	810fd0ef          	jal	800007e0 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
    800037d4:	24c1                	addw	s1,s1,16
    ...
    800037e2:	fc040613          	add	a2,s0,-64
    ...
    800037fa:	fc240593          	add	a1,s0,-62
...
000000008000395e <dirlink>:
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003988:	fc040613          	add	a2,s0,-64
  ...
  strncpy(de.name, name, DIRSIZ);
    ...
    800039ae:	fc240513          	add	a0,s0,-62
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    800039f0:	adc50513          	add	a0,a0,-1316 # 800074c8 <etext+0x4c8>
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    80003a00:	fe040613          	add	a2,s0,-32
...
{
    80003a12:	1141                	add	sp,sp,-16
    80003a14:	e406                	sd	ra,8(sp)
    80003a16:	e022                	sd	s0,0(sp)
    80003a18:	0800                	add	s0,sp,16
...
write_head(void)
{
    ...
    80003a34:	1000                	add	s0,sp,32
  struct buf *buf = bread(log.dev, log.start);
    80003a36:	0001c917          	auipc	s2,0x1c
    80003a3a:	ef290913          	add	s2,s2,-270 # 8001f928 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003a5a:	efe70713          	add	a4,a4,-258 # 8001f954 <log+0x2c>
    80003a5e:	87aa                	mv	a5,a0
    80003a60:	060a                	sll	a2,a2,0x2
    80003a62:	962a                	add	a2,a2,a0
    hb->block[i] = log.lh.block[i];
    80003a64:	4314                	lw	a3,0(a4)
    80003a66:	cff4                	sw	a3,92(a5)
  for (i = 0; i < log.lh.n; i++) {
    80003a68:	0711                	add	a4,a4,4
    80003a6a:	0791                	add	a5,a5,4
    ...
    80003a90:	0af05e63          	blez	a5,80003b4c <install_trans+0xc4>
{
    ...
    80003aa8:	0880                	add	s0,sp,80
    80003aaa:	8b2a                	mv	s6,a0
    80003aac:	0001ca97          	auipc	s5,0x1c
    80003ab0:	ea8a8a93          	add	s5,s5,-344 # 8001f954 <log+0x2c>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003ab4:	4981                	li	s3,0
      printf("recovering tail %d dst %d\n", tail, log.lh.block[tail]);
    80003ab6:	00004b97          	auipc	s7,0x4
    80003aba:	a22b8b93          	add	s7,s7,-1502 # 800074d8 <etext+0x4d8>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003abe:	0001ca17          	auipc	s4,0x1c
    80003ac2:	e6aa0a13          	add	s4,s4,-406 # 8001f928 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    80003ae2:	2985                	addw	s3,s3,1
    80003ae4:	0a91                	add	s5,s5,4
    ...
    80003b18:	05890593          	add	a1,s2,88
    80003b1c:	05850513          	add	a0,a0,88
    ...
    80003b48:	6161                	add	sp,sp,80
    80003b4a:	8082                	ret
    80003b4c:	8082                	ret

0000000080003b4e <initlog>:
{
    80003b4e:	7179                	add	sp,sp,-48
    ...
    80003b5a:	1800                	add	s0,sp,48
    80003b5c:	892a                	mv	s2,a0
    80003b5e:	89ae                	mv	s3,a1
  initlock(&log.lock, "log");
    80003b60:	0001c497          	auipc	s1,0x1c
    80003b64:	dc848493          	add	s1,s1,-568 # 8001f928 <log>
    80003b68:	00004597          	auipc	a1,0x4
    80003b6c:	99058593          	add	a1,a1,-1648 # 800074f8 <etext+0x4f8>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003b94:	dc470713          	add	a4,a4,-572 # 8001f954 <log+0x2c>
    80003b98:	060a                	sll	a2,a2,0x2
    80003b9a:	962a                	add	a2,a2,a0
    log.lh.block[i] = lh->block[i];
    80003b9c:	4ff4                	lw	a3,92(a5)
    80003b9e:	c314                	sw	a3,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80003ba0:	0791                	add	a5,a5,4
    80003ba2:	0711                	add	a4,a4,4
...
begin_op(void)
{
  ...
  while(1){
    ...
    80003bfe:	2705                	addw	a4,a4,1
    80003c00:	0027179b          	sllw	a5,a4,0x2
    80003c04:	9fb9                	addw	a5,a5,a4
    80003c06:	0017979b          	sllw	a5,a5,0x1
    ...
    80003c20:	d0c50513          	add	a0,a0,-756 # 8001f928 <log>
...
end_op(void)
{
  ...
  if(log.outstanding == 0){
    ...
    80003c66:	cc648493          	add	s1,s1,-826 # 8001f928 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003c7e:	cae48493          	add	s1,s1,-850 # 8001f928 <log>
    ...
    80003ca4:	86050513          	add	a0,a0,-1952 # 80007500 <etext+0x500>
    80003ca8:	b39fc0ef          	jal	800007e0 <panic>
    wakeup(&log);
    80003cac:	0001c497          	auipc	s1,0x1c
    80003cb0:	c7c48493          	add	s1,s1,-900 # 8001f928 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003cd6:	c82a8a93          	add	s5,s5,-894 # 8001f954 <log+0x2c>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80003cda:	0001ca17          	auipc	s4,0x1c
    80003cde:	c4ea0a13          	add	s4,s4,-946 # 8001f928 <log>
    80003ce2:	018a2583          	lw	a1,24(s4)
    80003ce6:	012585bb          	addw	a1,a1,s2
    80003cea:	2585                	addw	a1,a1,1
    ...
    80003d08:	05850593          	add	a1,a0,88
    80003d0c:	05848513          	add	a0,s1,88
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    80003d26:	2905                	addw	s2,s2,1
    80003d28:	0a91                	add	s5,s5,4
...
log_write(struct buf *b)
{
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003d8e:	bca70713          	add	a4,a4,-1078 # 8001f954 <log+0x2c>
  for (i = 0; i < log.lh.n; i++) {
  ...
  for (i = 0; i < log.lh.n; i++) {
    80003d9a:	2785                	addw	a5,a5,1
    80003d9c:	0711                	add	a4,a4,4
    80003d9e:	fef61be3          	bne	a2,a5,80003d94 <log_write+0x44>
      break;
  }
  log.lh.block[i] = b->blockno;
    80003da2:	0621                	add	a2,a2,8
    80003da4:	060a                	sll	a2,a2,0x2
    80003da6:	0001c797          	auipc	a5,0x1c
    80003daa:	b8278793          	add	a5,a5,-1150 # 8001f928 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003dbe:	b6e70713          	add	a4,a4,-1170 # 8001f928 <log>
    80003dc2:	571c                	lw	a5,40(a4)
    80003dc4:	2785                	addw	a5,a5,1
    80003dc6:	d71c                	sw	a5,40(a4)
    80003dc8:	a80d                	j	80003dfa <log_write+0xaa>
    panic("too big a transaction");
    80003dca:	00003517          	auipc	a0,0x3
    80003dce:	74650513          	add	a0,a0,1862 # 80007510 <etext+0x510>
    80003dd2:	a0ffc0ef          	jal	800007e0 <panic>
    panic("log_write outside of trans");
    80003dd6:	00003517          	auipc	a0,0x3
    80003dda:	75250513          	add	a0,a0,1874 # 80007528 <etext+0x528>
    80003dde:	a03fc0ef          	jal	800007e0 <panic>
  log.lh.block[i] = b->blockno;
    80003de2:	00878693          	add	a3,a5,8
    80003de6:	068a                	sll	a3,a3,0x2
    80003de8:	0001c717          	auipc	a4,0x1c
    80003dec:	b4070713          	add	a4,a4,-1216 # 8001f928 <log>
  ...
  release(&log.lock);
    ...
    80003dfe:	b2e50513          	add	a0,a0,-1234 # 8001f928 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003e26:	72658593          	add	a1,a1,1830 # 80007548 <etext+0x548>
    80003e2a:	0521                	add	a0,a0,8
...
acquiresleep(struct sleeplock *lk)
{
    ...
    80003e52:	1000                	add	s0,sp,32
    80003e54:	84aa                	mv	s1,a0
  acquire(&lk->lk);
    80003e56:	00850913          	add	s2,a0,8
...
fileinit(void)
{
    80003f10:	1141                	add	sp,sp,-16
    80003f12:	e406                	sd	ra,8(sp)
    80003f14:	e022                	sd	s0,0(sp)
    80003f16:	0800                	add	s0,sp,16
  initlock(&ftable.lock, "ftable");
    80003f18:	00003597          	auipc	a1,0x3
    80003f1c:	64058593          	add	a1,a1,1600 # 80007558 <etext+0x558>
    80003f20:	0001c517          	auipc	a0,0x1c
    80003f24:	b5050513          	add	a0,a0,-1200 # 8001fa70 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    80003f6a:	b0a50513          	add	a0,a0,-1270 # 8001fa70 <ftable>
  ...
  return 0;
    ...
    80003f7e:	af650513          	add	a0,a0,-1290 # 8001fa70 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003fa2:	ad250513          	add	a0,a0,-1326 # 8001fa70 <ftable>
  ...
  if(f->ref < 1)
    ...
    panic("filedup");
  f->ref++;
    80003fb0:	2785                	addw	a5,a5,1
    80003fb2:	c0dc                	sw	a5,4(s1)
  release(&ftable.lock);
    80003fb4:	0001c517          	auipc	a0,0x1c
    80003fb8:	abc50513          	add	a0,a0,-1348 # 8001fa70 <ftable>
  ...
  return f;
    ...
    80003fc8:	6105                	add	sp,sp,32
    80003fca:	8082                	ret
    panic("filedup");
    80003fcc:	00003517          	auipc	a0,0x3
    80003fd0:	59450513          	add	a0,a0,1428 # 80007560 <etext+0x560>
...
fileclose(struct file *f)
{
  ...
  release(&ftable.lock);
    ...
    80004026:	a4e50513          	add	a0,a0,-1458 # 8001fa70 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80004052:	51a50513          	add	a0,a0,1306 # 80007568 <etext+0x568>
    80004056:	f8afc0ef          	jal	800007e0 <panic>
    release(&ftable.lock);
    8000405a:	0001c517          	auipc	a0,0x1c
    8000405e:	a1650513          	add	a0,a0,-1514 # 8001fa70 <ftable>
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    stati(f->ip, &st);
    800040c2:	fb840593          	add	a1,s0,-72
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    8000416e:	03079693          	sll	a3,a5,0x30
    80004172:	92c1                	srl	a3,a3,0x30
    80004174:	4725                	li	a4,9
    80004176:	02d76863          	bltu	a4,a3,800041a6 <fileread+0xae>
    8000417a:	0792                	sll	a5,a5,0x4
    8000417c:	0001c717          	auipc	a4,0x1c
    80004180:	85470713          	add	a4,a4,-1964 # 8001f9d0 <devsw>
    ...
    8000419a:	3e250513          	add	a0,a0,994 # 80007578 <etext+0x578>
    ...
    800041ba:	10078b63          	beqz	a5,800042d0 <filewrite+0x11a>
{
  ...
  if(f->type == FD_PIPE){
    ...
    800041f8:	c00b8b93          	add	s7,s7,-1024 # c00 <_entry-0x7ffff400>
    800041fc:	6c05                	lui	s8,0x1
    800041fe:	c00c0c1b          	addw	s8,s8,-1024 # c00 <_entry-0x7ffff400>
    ...
    80004210:	03079693          	sll	a3,a5,0x30
    80004214:	92c1                	srl	a3,a3,0x30
    80004216:	4725                	li	a4,9
    80004218:	0ad76e63          	bltu	a4,a3,800042d4 <filewrite+0x11e>
    8000421c:	0792                	sll	a5,a5,0x4
    8000421e:	0001b717          	auipc	a4,0x1b
    80004222:	7b270713          	add	a4,a4,1970 # 8001f9d0 <devsw>
  ...
  return ret;
    ...
    800042c8:	2c450513          	add	a0,a0,708 # 80007588 <etext+0x588>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    8000432e:	26e58593          	add	a1,a1,622 # 80007598 <etext+0x598>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(writable){
    ...
    wakeup(&pi->nread);
    800043c6:	21848513          	add	a0,s1,536
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    wakeup(&pi->nwrite);
    800043f0:	21c48513          	add	a0,s1,540
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  int i = 0;
    ...
    80004432:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    80004434:	21848c13          	add	s8,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80004438:	21c48b93          	add	s7,s1,540
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80004512:	21848993          	add	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004590:	2985                	addw	s3,s3,1
    80004592:	0905                	add	s2,s2,1
    80004594:	fd3a92e3          	bne	s5,s3,80004558 <piperead+0x72>
    80004598:	89d6                	mv	s3,s5
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    8000459a:	21c48513          	add	a0,s1,540
...
{
    800045c6:	1141                	add	sp,sp,-16
    800045c8:	e422                	sd	s0,8(sp)
    800045ca:	0800                	add	s0,sp,16
    800045cc:	87aa                	mv	a5,a0
    int perm = 0;
    if(flags & 0x1)
    800045ce:	8905                	and	a0,a0,1
    800045d0:	050e                	sll	a0,a0,0x3
      perm = PTE_X;
    if(flags & 0x2)
    800045d2:	8b89                	and	a5,a5,2
    800045d4:	c399                	beqz	a5,800045da <flags2perm+0x14>
      perm |= PTE_W;
    800045d6:	00456513          	or	a0,a0,4
    return perm;
}
    800045da:	6422                	ld	s0,8(sp)
    800045dc:	0141                	add	sp,sp,16
    800045de:	8082                	ret
...
kexec(char *path, char **argv)
{
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    8000461c:	e5040613          	add	a2,s0,-432
  ...
  if(elf.magic != ELF_MAGIC)
    ...
    80004638:	57f78793          	add	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
 ...
 bad:
  ...
  return -1;
    ...
    8000465a:	21010113          	add	sp,sp,528
    8000465e:	8082                	ret
    end_op();
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    80004696:	fffc8793          	add	a5,s9,-1 # fff <_entry-0x7ffff001>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800046a6:	efe50513          	add	a0,a0,-258 # 800075a0 <etext+0x5a0>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    pa = walkaddr(pagetable, va + i);
    800046cc:	02091593          	sll	a1,s2,0x20
    800046d0:	9181                	srl	a1,a1,0x20
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    800046f2:	2d85                	addw	s11,s11,1
    800046f4:	038d0d1b          	addw	s10,s10,56 # 1038 <_entry-0x7fffefc8>
    ...
    80004708:	e1840613          	add	a2,s0,-488
  ...
  sz = PGROUNDUP(sz);
    ...
    80004794:	19fd                	add	s3,s3,-1 # fff <_entry-0x7ffff001>
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    800047d6:	e9040993          	add	s3,s0,-368
    800047da:	f9040c13          	add	s8,s0,-112
    800047de:	4481                	li	s1,0
    sp -= strlen(argv[argc]) + 1;
    800047e0:	e32fc0ef          	jal	80000e12 <strlen>
    800047e4:	0015079b          	addw	a5,a0,1
    800047e8:	40f907b3          	sub	a5,s2,a5
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    800047ec:	ff07f913          	and	s2,a5,-16
    if(sp < stackbase)
    ...
    80004802:	0015069b          	addw	a3,a0,1
  ...
  ustack[argc] = 0;
    80004838:	00349793          	sll	a5,s1,0x3
    8000483c:	f9078793          	add	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffde428>
    80004840:	97a2                	add	a5,a5,s0
    80004842:	f007b023          	sd	zero,-256(a5)
  sp -= (argc+1) * sizeof(uint64);
    80004846:	00148693          	add	a3,s1,1
    8000484a:	068e                	sll	a3,a3,0x3
    8000484c:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    80004850:	ff097913          	and	s2,s2,-16
  sz = sz1;
    80004854:	e0843983          	ld	s3,-504(s0)
  if(sp < stackbase)
    80004858:	f5796ee3          	bltu	s2,s7,800047b4 <kexec+0x1d4>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    8000485c:	e9040613          	add	a2,s0,-368
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    8000489e:	158a8513          	add	a0,s5,344
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  argint(n, &fd);
    80004962:	fdc40593          	add	a1,s0,-36
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    8000497c:	01a70793          	add	a5,a4,26
    80004980:	078e                	sll	a5,a5,0x3
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    800049bc:	0d050793          	add	a5,a0,208
  ...
  for(fd = 0; fd < NOFILE; fd++){
    800049c8:	2505                	addw	a0,a0,1
    800049ca:	07a1                	add	a5,a5,8
  ...
  return -1;
    ...
    800049da:	8082                	ret
      p->ofile[fd] = f;
    800049dc:	01a50793          	add	a5,a0,26
    800049e0:	078e                	sll	a5,a5,0x3
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80004a14:	fb040593          	add	a1,s0,-80
    ...
    80004a38:	37f9                	addw	a5,a5,-2
    80004a3a:	17c2                	sll	a5,a5,0x30
    80004a3c:	93c1                	srl	a5,a5,0x30
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    ...
    80004a90:	fb040593          	add	a1,s0,-80
  ...
  return ip;
    ...
    80004abe:	b0658593          	add	a1,a1,-1274 # 800075c0 <etext+0x5c0>
    ...
    80004ad2:	afa58593          	add	a1,a1,-1286 # 800075c8 <etext+0x5c8>
...
{
    80004b22:	7179                	add	sp,sp,-48
    80004b24:	f406                	sd	ra,40(sp)
    80004b26:	f022                	sd	s0,32(sp)
    80004b28:	1800                	add	s0,sp,48
  if(argfd(0, 0, &f) < 0)
    80004b2a:	fd840613          	add	a2,s0,-40
...
{
    80004bfe:	1101                	add	sp,sp,-32
    80004c00:	ec06                	sd	ra,24(sp)
    80004c02:	e822                	sd	s0,16(sp)
    80004c04:	1000                	add	s0,sp,32
  if(argfd(0, &fd, &f) < 0)
    80004c06:	fe040613          	add	a2,s0,-32
    80004c0a:	fec40593          	add	a1,s0,-20
  ...
  myproc()->ofile[fd] = 0;
    ...
    80004c22:	07e9                	add	a5,a5,26
    80004c24:	078e                	sll	a5,a5,0x3
  ...
  return 0;
    ...
    80004c3c:	6105                	add	sp,sp,32
    80004c3e:	8082                	ret

0000000080004c40 <sys_fstat>:
{
    80004c40:	1101                	add	sp,sp,-32
    80004c42:	ec06                	sd	ra,24(sp)
    80004c44:	e822                	sd	s0,16(sp)
    80004c46:	1000                	add	s0,sp,32
  argaddr(1, &st);
    80004c48:	fe040593          	add	a1,s0,-32
    80004c4c:	4505                	li	a0,1
    80004c4e:	babfd0ef          	jal	800027f8 <argaddr>
  if(argfd(0, 0, &f) < 0)
    80004c52:	fe840613          	add	a2,s0,-24
...
0000000080004c7a <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80004c9a:	f5040593          	add	a1,s0,-176
  ...
  if((ip = namei(old)) == 0){
    80004cb0:	ed040513          	add	a0,s0,-304
  ...
  if((dp = nameiparent(new, name)) == 0)
    80004ce2:	fd040593          	add	a1,s0,-48
    80004ce6:	f5040513          	add	a0,s0,-176
  ...
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    ...
    80004d02:	fd040593          	add	a1,s0,-48
  ...
  return -1;
    ...
    80004d74:	6155                	add	sp,sp,304
    80004d76:	8082                	ret

0000000080004d78 <sys_unlink>:
{
    80004d78:	7151                	add	sp,sp,-240
    80004d7a:	f586                	sd	ra,232(sp)
    80004d7c:	f1a2                	sd	s0,224(sp)
    80004d7e:	1980                	add	s0,sp,240
  if(argstr(0, path, MAXPATH) < 0)
    80004d80:	08000613          	li	a2,128
    80004d84:	f3040593          	add	a1,s0,-208
  ...
  if((dp = nameiparent(path, name)) == 0){
    80004d98:	fb040593          	add	a1,s0,-80
    80004d9c:	f3040513          	add	a0,s0,-208
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    80004db0:	81458593          	add	a1,a1,-2028 # 800075c0 <etext+0x5c0>
    80004db4:	fb040513          	add	a0,s0,-80
    80004db8:	9c5fe0ef          	jal	8000377c <namecmp>
    80004dbc:	10050e63          	beqz	a0,80004ed8 <sys_unlink+0x160>
    80004dc0:	00003597          	auipc	a1,0x3
    80004dc4:	80858593          	add	a1,a1,-2040 # 800075c8 <etext+0x5c8>
  ...
  if((ip = dirlookup(dp, name, &off)) == 0)
    80004dd6:	f2c40613          	add	a2,s0,-212
    80004dda:	fb040593          	add	a1,s0,-80
  ...
  return 0;
    ...
    80004e66:	76e50513          	add	a0,a0,1902 # 800075d0 <etext+0x5d0>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004e84:	f1840613          	add	a2,s0,-232
...
sys_open(void)
{
  ...
  f->readable = !(omode & O_WRONLY);
    ...
    80004f8e:	0017c713          	xor	a4,a5,1
    80004f92:	8b05                	and	a4,a4,1
    80004f94:	00e90423          	sb	a4,8(s2)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
    80004f98:	0037f713          	and	a4,a5,3
    80004f9c:	00e03733          	snez	a4,a4
    80004fa0:	00e904a3          	sb	a4,9(s2)

  if((omode & O_TRUNC) && ip->type == T_FILE){
    80004fa4:	4007f793          	and	a5,a5,1024
  ...
  return fd;
    ...
    if((ip = namei(path)) == 0){
    80004fd8:	f5040513          	add	a0,s0,-176
...
sys_mkdir(void)
{
    80005052:	7175                	add	sp,sp,-144
    80005054:	e506                	sd	ra,136(sp)
    80005056:	e122                	sd	s0,128(sp)
    80005058:	0900                	add	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005062:	f7040593          	add	a1,s0,-144
    ...
    80005076:	f7040513          	add	a0,s0,-144
...
sys_mknod(void)
{
    8000509a:	7135                	add	sp,sp,-160
    8000509c:	ed06                	sd	ra,152(sp)
    8000509e:	e922                	sd	s0,144(sp)
    800050a0:	1100                	add	s0,sp,160
  struct inode *ip;
  char path[MAXPATH];
  int major, minor;
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    800050d6:	f7040513          	add	a0,s0,-144
...
sys_chdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80005112:	f6040593          	add	a1,s0,-160
    ...
    80005122:	f6040513          	add	a0,s0,-160
...
sys_exec(void)
{
  ...
  memset(argv, 0, sizeof(argv));
    ...
    800051b0:	e5040513          	add	a0,s0,-432
    800051b4:	aeffb0ef          	jal	80000ca2 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    800051b8:	e5040493          	add	s1,s0,-432
  memset(argv, 0, sizeof(argv));
    ...
    800051c4:	00391513          	sll	a0,s2,0x3
    800051c8:	e4040593          	add	a1,s0,-448
    ...
    if(i >= NELEM(argv)){
    800051fa:	0905                	add	s2,s2,1
    800051fc:	09a1                	add	s3,s3,8
...
sys_pipe(void)
{
  ...
  argaddr(0, &fdarray);
    8000527e:	fd840593          	add	a1,s0,-40
    80005282:	4501                	li	a0,0
    80005284:	d74fd0ef          	jal	800027f8 <argaddr>
  if(pipealloc(&rf, &wf) < 0)
    80005288:	fc840593          	add	a1,s0,-56
    8000528c:	fd040513          	add	a0,s0,-48
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800052c0:	fc440613          	add	a2,s0,-60
    ...
    800052d4:	fc040613          	add	a2,s0,-64
    800052d8:	fd843583          	ld	a1,-40(s0)
    800052dc:	0591                	add	a1,a1,4
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800052fc:	07e9                	add	a5,a5,26
    800052fe:	078e                	sll	a5,a5,0x3
    ...
    8000531e:	0007c763          	bltz	a5,8000532c <sys_pipe+0xbe>
      p->ofile[fd0] = 0;
    80005322:	07e9                	add	a5,a5,26
    80005324:	078e                	sll	a5,a5,0x3
...
plicinit(void)
{
    800053ae:	1141                	add	sp,sp,-16
    800053b0:	e422                	sd	s0,8(sp)
    800053b2:	0800                	add	s0,sp,16
...
plicinithart(void)
{
  ...
  *(uint32*)PLIC_SENABLE(hart) = (1 << UART0_IRQ) | (1 << VIRTIO0_IRQ);
    800053d4:	0085171b          	sllw	a4,a0,0x8
...
plic_complete(int irq)
{
  ...
  *(uint32*)PLIC_SCLAIM(hart) = irq;
    8000542c:	00d5151b          	sllw	a0,a0,0xd
...
00000000800054b8 <virtio_disk_init>:
{
  ...
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    ...
    800054e4:	97678793          	add	a5,a5,-1674 # 74726976 <_entry-0xb8d968a>
    800054e8:	18f71063          	bne	a4,a5,80005668 <virtio_disk_init+0x1b0>
     *R(VIRTIO_MMIO_VERSION) != 2 ||
    800054ec:	100017b7          	lui	a5,0x10001
    800054f0:	0791                	add	a5,a5,4 # 10001004 <_entry-0x6fffeffc>
  ...
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    ...
    80005500:	07a1                	add	a5,a5,8 # 10001008 <_entry-0x6fffeff8>
    ...
    80005516:	55178793          	add	a5,a5,1361 # 554d4551 <_entry-0x2ab2baaf>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005538:	75f70713          	add	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fddbf7>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  if(*R(VIRTIO_MMIO_QUEUE_READY))
    ...
    80005564:	04478793          	add	a5,a5,68 # 10001044 <_entry-0x6fffefbc>
  ...
  uint32 max = *R(VIRTIO_MMIO_QUEUE_NUM_MAX);
    ...
    80005574:	03478793          	add	a5,a5,52 # 10001034 <_entry-0x6fffefcc>
  ...
  disk.desc = kalloc();
    ...
    8000558e:	49e48493          	add	s1,s1,1182 # 80020a28 <disk>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    800055c4:	46848493          	add	s1,s1,1128 # 80020a28 <disk>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
    ...
    8000566c:	fd850513          	add	a0,a0,-40 # 80007640 <etext+0x640>
    80005670:	970fb0ef          	jal	800007e0 <panic>
    panic("virtio disk FEATURES_OK unset");
    80005674:	00002517          	auipc	a0,0x2
    80005678:	fec50513          	add	a0,a0,-20 # 80007660 <etext+0x660>
    ...
    80005690:	01450513          	add	a0,a0,20 # 800076a0 <etext+0x6a0>
    80005694:	94cfb0ef          	jal	800007e0 <panic>
    panic("virtio disk max queue too short");
    80005698:	00002517          	auipc	a0,0x2
    8000569c:	02850513          	add	a0,a0,40 # 800076c0 <etext+0x6c0>
    800056a0:	940fb0ef          	jal	800007e0 <panic>
    panic("virtio disk kalloc");
    800056a4:	00002517          	auipc	a0,0x2
    800056a8:	03c50513          	add	a0,a0,60 # 800076e0 <etext+0x6e0>
...
virtio_disk_rw(struct buf *b, int write)
{
    ...
    800056c8:	1880                	add	s0,sp,112
    800056ca:	8a2a                	mv	s4,a0
    800056cc:	8bae                	mv	s7,a1
  uint64 sector = b->blockno * (BSIZE / 512);
    800056ce:	00c52c83          	lw	s9,12(a0)
    800056d2:	001c9c9b          	sllw	s9,s9,0x1
    800056d6:	1c82                	sll	s9,s9,0x20
    800056d8:	020cdc93          	srl	s9,s9,0x20

  acquire(&disk.vdisk_lock);
    800056dc:	0001b517          	auipc	a0,0x1b
    800056e0:	47450513          	add	a0,a0,1140 # 80020b50 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800056f0:	33cb0b13          	add	s6,s6,828 # 80020a28 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    800056fa:	45ac0c13          	add	s8,s8,1114 # 80020b50 <disk+0x128>
  ...
  for(int i = 0; i < 3; i++){
    8000570e:	2905                	addw	s2,s2,1
    80005710:	0611                	add	a2,a2,4 # 1004 <_entry-0x7fffeffc>
    80005712:	05590963          	beq	s2,s5,80005764 <virtio_disk_rw+0xb4>
    idx[i] = alloc_desc();
    80005716:	85b2                	mv	a1,a2
  for(int i = 0; i < NUM; i++){
    80005718:	0001b717          	auipc	a4,0x1b
    8000571c:	31070713          	add	a4,a4,784 # 80020a28 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005754:	2f050513          	add	a0,a0,752 # 80020a40 <disk+0x18>
    80005758:	f80fc0ef          	jal	80001ed8 <sleep>
  for(int i = 0; i < 3; i++){
    8000575c:	f9040613          	add	a2,s0,-112
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    80005768:	00451693          	sll	a3,a0,0x4

  if(write)
    8000576c:	0001b797          	auipc	a5,0x1b
    80005770:	2bc78793          	add	a5,a5,700 # 80020a28 <disk>
    80005774:	00a50713          	add	a4,a0,10
    80005778:	0712                	sll	a4,a4,0x4
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    8000578e:	0a868613          	add	a2,a3,168
  ...
  disk.desc[idx[1]].addr = (uint64) b->data;
    800057ae:	0712                	sll	a4,a4,0x4
    800057b0:	963a                	add	a2,a2,a4
    800057b2:	058a0593          	add	a1,s4,88
  ...
  if(write)
    ...
    800057c8:	0016161b          	sllw	a2,a2,0x1
    disk.desc[idx[1]].flags = 0; // device reads b->data
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    800057cc:	00166613          	or	a2,a2,1
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    800057dc:	00250613          	add	a2,a0,2
    800057e0:	0612                	sll	a2,a2,0x4
    800057e2:	963e                	add	a2,a2,a5
    800057e4:	577d                	li	a4,-1
    800057e6:	00e60823          	sb	a4,16(a2)
  disk.desc[idx[2]].addr = (uint64) &disk.info[idx[0]].status;
    800057ea:	0592                	sll	a1,a1,0x4
    800057ec:	98ae                	add	a7,a7,a1
    800057ee:	03068713          	add	a4,a3,48
  ...
  disk.avail->ring[disk.avail->idx % NUM] = idx[0];
    ...
    80005818:	8b1d                	and	a4,a4,7
    8000581a:	0706                	sll	a4,a4,0x1
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80005846:	30e90913          	add	s2,s2,782 # 80020b50 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80005864:	00290713          	add	a4,s2,2
    80005868:	0712                	sll	a4,a4,0x4
    8000586a:	0001b797          	auipc	a5,0x1b
    8000586e:	1be78793          	add	a5,a5,446 # 80020a28 <disk>
    80005872:	97ba                	add	a5,a5,a4
    80005874:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80005878:	0001b997          	auipc	s3,0x1b
    8000587c:	1b098993          	add	s3,s3,432 # 80020a28 <disk>
    80005880:	00491713          	sll	a4,s2,0x4
...
virtio_disk_intr()
{
    800058c2:	1101                	add	sp,sp,-32
    800058c4:	ec06                	sd	ra,24(sp)
    800058c6:	e822                	sd	s0,16(sp)
    800058c8:	e426                	sd	s1,8(sp)
    800058ca:	1000                	add	s0,sp,32
  acquire(&disk.vdisk_lock);
    800058cc:	0001b497          	auipc	s1,0x1b
    800058d0:	15c48493          	add	s1,s1,348 # 80020a28 <disk>
    800058d4:	0001b517          	auipc	a0,0x1b
    800058d8:	27c50513          	add	a0,a0,636 # 80020b50 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    8000590a:	8b9d                	and	a5,a5,7
    8000590c:	078e                	sll	a5,a5,0x3
    8000590e:	97ba                	add	a5,a5,a4
    80005910:	43dc                	lw	a5,4(a5)

    if(disk.info[id].status != 0)
    80005912:	00278713          	add	a4,a5,2
    80005916:	0712                	sll	a4,a4,0x4
    ...
    80005920:	0789                	add	a5,a5,2
    80005922:	0792                	sll	a5,a5,0x4
    ...
    80005934:	2785                	addw	a5,a5,1
    80005936:	17c2                	sll	a5,a5,0x30
    80005938:	93c1                	srl	a5,a5,0x30
  ...
  release(&disk.vdisk_lock);
    ...
    8000594c:	20850513          	add	a0,a0,520 # 80020b50 <disk+0x128>
    ...
    80005962:	d9a50513          	add	a0,a0,-614 # 800076f8 <etext+0x6f8>
